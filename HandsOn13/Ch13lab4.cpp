...
int const NUMOFPROD = 10;   // This holds the number of products a store sells
...
void Inventory::getId(int idd)
{
    itemNumber = idd;
}

void Inventory::getAmount(int amounts)
{
    numOfItem = amounts;
}
