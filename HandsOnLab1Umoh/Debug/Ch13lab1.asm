; Listing generated by Microsoft (R) Optimizing Compiler Version 19.28.29336.0 
	...
	TITLE	C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch13lab1.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__22D28D23_Ch13lab1@cpp DB 01H
...
PUBLIC	?setSide@Square@@QAEXM@Z			; Square::setSide
PUBLIC	?findArea@Square@@QAEMXZ			; Square::findArea
PUBLIC	?findPerimeter@Square@@QAEMXZ			; Square::findPerimeter
PUBLIC	??0Square@@QAE@XZ				; Square::Square
PUBLIC	??0Square@@QAE@M@Z				; Square::Square
PUBLIC	??1Square@@QAE@XZ				; Square::~Square
PUBLIC	_main
...
PUBLIC	??_C@_0DA@EJAPDFJL@Please?5input?5the?5size?5of?5the?5si@ ; `string'
PUBLIC	??_C@_0BL@EDCOPPDH@The?5area?5of?5the?5square?5is?5@ ; `string'
PUBLIC	??_C@_0CA@BEGALPKN@The?5perimeter?5of?5the?5square?5is?5@ ; `string'
PUBLIC	??_C@_0BF@FENBKELL@The?5area?5of?5box1?5is?5@	; `string'
PUBLIC	??_C@_0BL@LEKEKGDL@The?5perimeter?5of?5box?51?5is?5@ ; `string'
...
rtc$IMZ	ENDS
;	COMDAT ??_C@_0BL@LEKEKGDL@The?5perimeter?5of?5box?51?5is?5@
CONST	SEGMENT
??_C@_0BL@LEKEKGDL@The?5perimeter?5of?5box?51?5is?5@ DB 'The perimeter of'
	DB	' box 1 is ', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0BF@FENBKELL@The?5area?5of?5box1?5is?5@
CONST	SEGMENT
??_C@_0BF@FENBKELL@The?5area?5of?5box1?5is?5@ DB 'The area of box1 is ', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0CA@BEGALPKN@The?5perimeter?5of?5the?5square?5is?5@
CONST	SEGMENT
??_C@_0CA@BEGALPKN@The?5perimeter?5of?5the?5square?5is?5@ DB 'The perimet'
	DB	'er of the square is ', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0BL@EDCOPPDH@The?5area?5of?5the?5square?5is?5@
CONST	SEGMENT
??_C@_0BL@EDCOPPDH@The?5area?5of?5the?5square?5is?5@ DB 'The area of the '
	DB	'square is ', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0DA@EJAPDFJL@Please?5input?5the?5size?5of?5the?5si@
CONST	SEGMENT
??_C@_0DA@EJAPDFJL@Please?5input?5the?5size?5of?5the?5si@ DB 'Please inpu'
	DB	't the size of the side of the square', 00H	; `string'
CONST	ENDS
;	COMDAT xdata$x
xdata$x	SEGMENT
...
; 22   : {
	...
	lea	eax, DWORD PTR __$EHRec$[ebp]
	mov	DWORD PTR fs:0, eax
	mov	ecx, OFFSET __22D28D23_Ch13lab1@cpp
	call	@__CheckForDebuggerJustMyCode@4

; 23   :     Square  box;          // box is defined as an object of the Square class

	lea	ecx, DWORD PTR _box$[ebp]
	call	??0Square@@QAE@XZ			; Square::Square
	mov	DWORD PTR __$EHRec$[ebp+8], 0

; 24   :     float   size;         // size contains the length of a side of the square  
; 25   :     Square  box1(9); 
	...
	call	??0Square@@QAE@M@Z			; Square::Square
	mov	BYTE PTR __$EHRec$[ebp+8], 1

; 26   : 
; 27   :    // FILL IN THE CLIENT CODE THAT WILL ASK THE USER FOR THE LENGTH OF THE SIDE 
; 28   :    // OF THE SQUARE.  (This is stored in size)
; 29   :     cout << "Please input the size of the side of the square" << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0DA@EJAPDFJL@Please?5input?5the?5size?5of?5the?5si@
...
; 31   :     box.setSide(size);
	...
	movss	DWORD PTR [esp], xmm0
	lea	ecx, DWORD PTR _box$[ebp]
	call	?setSide@Square@@QAEXM@Z		; Square::setSide

; 32   : 
; 33   :    // FILL IN THE CODE THAT CALLS SetSide.
; 34   : 
; 35   :    // FILL IN THE CODE THAT WILL RETURN THE AREA FROM A CALL TO A FUNCTION
; 36   :    // AND PRINT OUT THE AREA TO THE SCREEN 
; 37   :     cout << "The area of the square is " << box.findArea() << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	lea	ecx, DWORD PTR _box$[ebp]
	call	?findArea@Square@@QAEMXZ		; Square::findArea
	mov	edi, esp
	push	ecx
	fstp	DWORD PTR [esp]
	push	OFFSET ??_C@_0BL@EDCOPPDH@The?5area?5of?5the?5square?5is?5@
	mov	eax, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	eax
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
...
; 38   :    // FILL IN THE CODE THAT WILL RETURN THE PERIMETER FROM A CALL TO A 
; 39   :    // FUNCTION AND PRINT OUT THAT VALUE TO THE SCREEN
; 40   :     cout << "The perimeter of the square is " << box.findPerimeter() << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	lea	ecx, DWORD PTR _box$[ebp]
	call	?findPerimeter@Square@@QAEMXZ		; Square::findPerimeter
	mov	edi, esp
	push	ecx
	fstp	DWORD PTR [esp]
	push	OFFSET ??_C@_0CA@BEGALPKN@The?5perimeter?5of?5the?5square?5is?5@
	mov	eax, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	eax
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
...
; 41   : 
; 42   :     cout << endl<<"The area of box1 is " << box1.findArea() << endl;
	...
	push	ecx
	fstp	DWORD PTR [esp]
	push	OFFSET ??_C@_0BF@FENBKELL@The?5area?5of?5box1?5is?5@
	mov	ebx, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
...
; 43   :     cout << "The perimeter of box 1 is " << box1.findPerimeter() << endl;
	...
	push	ecx
	fstp	DWORD PTR [esp]
	push	OFFSET ??_C@_0BL@LEKEKGDL@The?5perimeter?5of?5box?51?5is?5@
	mov	eax, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	eax
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
...
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch13lab1.cpp
;	COMDAT ??1Square@@QAE@XZ
_TEXT	SEGMENT
_this$ = -8						; size = 4
??1Square@@QAE@XZ PROC					; Square::~Square, COMDAT
; _this$ = ecx
...
; 60   : }
	...
	pop	ebp
	ret	0
??1Square@@QAE@XZ ENDP					; Square::~Square
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch13lab1.cpp
;	COMDAT ??0Square@@QAE@M@Z
_TEXT	SEGMENT
_this$ = -8						; size = 4
_length$ = 8						; size = 4
??0Square@@QAE@M@Z PROC					; Square::Square, COMDAT
; _this$ = ecx
...
; 55   : }
	...
	pop	ebp
	ret	4
??0Square@@QAE@M@Z ENDP					; Square::Square
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch13lab1.cpp
;	COMDAT ??0Square@@QAE@XZ
_TEXT	SEGMENT
_this$ = -8						; size = 4
??0Square@@QAE@XZ PROC					; Square::Square, COMDAT
; _this$ = ecx
...
; 50   : }
	...
	pop	ebp
	ret	0
??0Square@@QAE@XZ ENDP					; Square::Square
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch13lab1.cpp
;	COMDAT ?findPerimeter@Square@@QAEMXZ
_TEXT	SEGMENT
tv70 = -208						; size = 4
_this$ = -8						; size = 4
?findPerimeter@Square@@QAEMXZ PROC			; Square::findPerimeter, COMDAT
; _this$ = ecx
...
; 100  : }
	...
	pop	ebp
	ret	0
?findPerimeter@Square@@QAEMXZ ENDP			; Square::findPerimeter
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch13lab1.cpp
;	COMDAT ?findArea@Square@@QAEMXZ
_TEXT	SEGMENT
tv72 = -208						; size = 4
_this$ = -8						; size = 4
?findArea@Square@@QAEMXZ PROC				; Square::findArea, COMDAT
; _this$ = ecx
...
; 89   : }
	...
	pop	ebp
	ret	0
?findArea@Square@@QAEMXZ ENDP				; Square::findArea
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch13lab1.cpp
;	COMDAT ?setSide@Square@@QAEXM@Z
_TEXT	SEGMENT
_this$ = -8						; size = 4
_length$ = 8						; size = 4
?setSide@Square@@QAEXM@Z PROC				; Square::setSide, COMDAT
; _this$ = ecx
...
; 77   : }
	...
	pop	ebp
	ret	4
?setSide@Square@@QAEXM@Z ENDP				; Square::setSide
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
