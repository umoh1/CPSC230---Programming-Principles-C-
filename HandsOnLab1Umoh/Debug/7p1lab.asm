; Listing generated by Microsoft (R) Optimizing Compiler Version 19.28.29336.0 
	...
	TITLE	C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\7p1lab.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?findAverage@@YAMQBHH@Z				; findAverage
PUBLIC	?findHighest@@YAHQBHH@Z				; findHighest
PUBLIC	?findLowest@@YAHQBHH@Z				; findLowest
PUBLIC	_main
...
PUBLIC	??_C@_0DF@PMOLPDKL@Please?5input?5a?5grade?5from?51?5to?5@ ; `string'
PUBLIC	??_C@_0CC@HBNMAIGK@The?5average?5of?5all?5the?5grades?5i@ ; `string'
PUBLIC	??_C@_0BG@JLHKMJNN@The?5highest?5grade?5is?5@	; `string'
PUBLIC	??_C@_0BF@FJDAOLIL@The?5lowest?5grade?5is?5@	; `string'
EXTRN	_strlen:PROC
...
rtc$IMZ	ENDS
;	COMDAT ??_C@_0BF@FJDAOLIL@The?5lowest?5grade?5is?5@
CONST	SEGMENT
??_C@_0BF@FJDAOLIL@The?5lowest?5grade?5is?5@ DB 'The lowest grade is ', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BG@JLHKMJNN@The?5highest?5grade?5is?5@
CONST	SEGMENT
??_C@_0BG@JLHKMJNN@The?5highest?5grade?5is?5@ DB 'The highest grade is ', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0CC@HBNMAIGK@The?5average?5of?5all?5the?5grades?5i@
CONST	SEGMENT
??_C@_0CC@HBNMAIGK@The?5average?5of?5all?5the?5grades?5i@ DB 'The average'
	DB	' of all the grades is ', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_0DF@PMOLPDKL@Please?5input?5a?5grade?5from?51?5to?5@
CONST	SEGMENT
??_C@_0DF@PMOLPDKL@Please?5input?5a?5grade?5from?51?5to?5@ DB 'Please inp'
	DB	'ut a grade from 1 to 100, (or -99 to stop)', 00H ; `string'
CONST	ENDS
;	COMDAT xdata$x
xdata$x	SEGMENT
...
;	COMDAT _main
_TEXT	SEGMENT
_lowestGrade$ = -468					; size = 4
_highestGrade$ = -456					; size = 4
_avgOfGrades$ = -444					; size = 4
_pos$ = -432						; size = 4
_numberOfGrades$ = -420					; size = 4
_grades$ = -408						; size = 400
...
; 20   : {
	...
	xor	eax, ebp
	mov	DWORD PTR __$ArrayPad$[ebp], eax
	mov	ecx, OFFSET __23E92811_7p1lab@cpp
	call	@__CheckForDebuggerJustMyCode@4

; 21   : 	GradeType  grades;				   // the array holding the grades.
; 22   : 	int  numberOfGrades;				   // the number of grades read.
; 23   : 	int pos;							   // index to the array.
; 24   : 
; 25   : 	float avgOfGrades;			   // contains the average of the grades.
; 26   : 	int highestGrade;			   // contains the highest grade.
; 27   : 	int lowestGrade;			   // contains the lowest grade.
; 28   : 
; 29   : 	// Read in the values into the array
; 30   : 
; 31   : 	pos = 0;

	mov	DWORD PTR _pos$[ebp], 0

; 32   : 	cout << "Please input a grade from 1 to 100, (or -99 to stop)" << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0DF@PMOLPDKL@Please?5input?5a?5grade?5from?51?5to?5@
...
; 33   : 	cin >> grades[pos];
	...
	lea	ecx, DWORD PTR _grades$[ebp+eax*4]
	mov	esi, esp
	push	ecx
...
; 34   : 
; 35   : 	while (grades[pos] != -99)

	mov	eax, DWORD PTR _pos$[ebp]
	cmp	DWORD PTR _grades$[ebp+eax*4], -99	; ffffff9dH
	je	SHORT $LN3@main
...
; 38   : 		// Fill in the code to read the grades
; 39   : 		cout << "Please input a grade from 1 to 100, (or -99 to stop)" << endl;
...
; 42   : 
; 43   : 	numberOfGrades = pos;  // Fill blank with appropriate identifier

	mov	eax, DWORD PTR _pos$[ebp]
	mov	DWORD PTR _numberOfGrades$[ebp], eax

; 44   : 
; 45   : 	// call to the function to find average
; 46   : 
; 47   : 	avgOfGrades = findAverage(grades, numberOfGrades);

	mov	eax, DWORD PTR _numberOfGrades$[ebp]
	push	eax
	lea	ecx, DWORD PTR _grades$[ebp]
	push	ecx
	call	?findAverage@@YAMQBHH@Z			; findAverage
	add	esp, 8
	fstp	DWORD PTR _avgOfGrades$[ebp]

; 48   : 
; 49   : 	cout << endl << "The average of all the grades is " << avgOfGrades << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	mov	edi, esp
	push	ecx
	movss	xmm0, DWORD PTR _avgOfGrades$[ebp]
	movss	DWORD PTR [esp], xmm0
	push	OFFSET ??_C@_0CC@HBNMAIGK@The?5average?5of?5all?5the?5grades?5i@
	mov	ebx, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
...
; 50   : 
; 51   : 
; 52   : 	//  Fill in the call to the function that calculates highest grade
; 53   : 	highestGrade = findHighest(grades, pos);

	mov	eax, DWORD PTR _pos$[ebp]
	push	eax
	lea	ecx, DWORD PTR _grades$[ebp]
	push	ecx
	call	?findHighest@@YAHQBHH@Z			; findHighest
	add	esp, 8
	mov	DWORD PTR _highestGrade$[ebp], eax

; 54   : 
; 55   : 	cout << endl << "The highest grade is " << highestGrade << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	mov	edi, esp
	mov	eax, DWORD PTR _highestGrade$[ebp]
	push	eax
	push	OFFSET ??_C@_0BG@JLHKMJNN@The?5highest?5grade?5is?5@
	mov	ebx, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	mov	ecx, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	call	DWORD PTR __imp_??6?$basic_ostream@DU?$char_traits@D@std@@@std@@QAEAAV01@P6AAAV01@AAV01@@Z@Z
...
; 56   : 
; 57   : 
; 58   : 	// Fill in the call to the function that calculates lowest grade
; 59   : 	
; 60   : 	lowestGrade = findLowest(grades, pos);

	mov	eax, DWORD PTR _pos$[ebp]
	push	eax
	lea	ecx, DWORD PTR _grades$[ebp]
	push	ecx
	call	?findLowest@@YAHQBHH@Z			; findLowest
	add	esp, 8
	mov	DWORD PTR _lowestGrade$[ebp], eax

; 61   : 
; 62   : 	  // Fill in code to write the lowest to the screen
; 63   : 	cout << endl << "The lowest grade is " << lowestGrade << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	mov	edi, esp
	mov	eax, DWORD PTR _lowestGrade$[ebp]
	push	eax
	push	OFFSET ??_C@_0BF@FJDAOLIL@The?5lowest?5grade?5is?5@
	mov	ebx, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	mov	ecx, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	call	DWORD PTR __imp_??6?$basic_ostream@DU?$char_traits@D@std@@@std@@QAEAAV01@P6AAAV01@AAV01@@Z@Z
...
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\7p1lab.cpp
;	COMDAT ?findLowest@@YAHQBHH@Z
_TEXT	SEGMENT
_i$1 = -20						; size = 4
_compare$ = -8						; size = 4
_array$ = 8						; size = 4
_size$ = 12						; size = 4
?findLowest@@YAHQBHH@Z PROC				; findLowest, COMDAT
...
; 139  : 	// Fill in the code for this function
; 140  : 	int compare = array[0];  //used to compare values
...
$LN4@findLowest:
	...
	jge	SHORT $LN3@findLowest

; 144  : 	{
; 145  : 		//if the current array element is larger than the comparison value, 
; 146  : 		//replace the comparison value with the current element
; 147  : 		if (array[i] < compare)

	mov	eax, DWORD PTR _i$1[ebp]
	mov	ecx, DWORD PTR _array$[ebp]
	mov	edx, DWORD PTR [ecx+eax*4]
	cmp	edx, DWORD PTR _compare$[ebp]
	jge	SHORT $LN5@findLowest
...
; 149  : 			compare = array[i];
	...
	mov	ecx, DWORD PTR _array$[ebp]
	mov	edx, DWORD PTR [ecx+eax*4]
	mov	DWORD PTR _compare$[ebp], edx
$LN5@findLowest:

; 150  : 		}
; 151  : 	}

	jmp	SHORT $LN2@findLowest
$LN3@findLowest:

; 152  : 
; 153  : 	//after loop, compare should have the highest value in the array, so return it. 
; 154  : 	return compare;
...
; 156  : }
	...
	pop	ebp
	ret	0
?findLowest@@YAHQBHH@Z ENDP				; findLowest
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\7p1lab.cpp
;	COMDAT ?findHighest@@YAHQBHH@Z
_TEXT	SEGMENT
_i$1 = -20						; size = 4
_compare$ = -8						; size = 4
_array$ = 8						; size = 4
_size$ = 12						; size = 4
?findHighest@@YAHQBHH@Z PROC				; findHighest, COMDAT
...
; 104  : 
; 105  : 	// Fill in the code for this function
; 106  : 	int compare = array[0];  //used to compare values
...
$LN4@findHighes:
	mov	eax, DWORD PTR _i$1[ebp]
	cmp	eax, DWORD PTR _size$[ebp]
	jge	SHORT $LN3@findHighes

; 110  : 	{
; 111  : 		//if the current array element is larger than the comparison value, 
; 112  : 		//replace the comparison value with the current element
; 113  : 		if (array[i] > compare)

	mov	eax, DWORD PTR _i$1[ebp]
	mov	ecx, DWORD PTR _array$[ebp]
	mov	edx, DWORD PTR [ecx+eax*4]
	cmp	edx, DWORD PTR _compare$[ebp]
	jle	SHORT $LN5@findHighes
...
; 117  : 	}
	...
	jmp	SHORT $LN2@findHighes
$LN3@findHighes:

; 118  : 
; 119  : 	//after loop, compare should have the highest value in the array, so return it. 
; 120  : 	return compare;
...
; 122  : }
	...
	pop	ebp
	ret	0
?findHighest@@YAHQBHH@Z ENDP				; findHighest
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\7p1lab.cpp
;	COMDAT ?findAverage@@YAMQBHH@Z
_TEXT	SEGMENT
tv82 = -220						; size = 4
_pos$1 = -20						; size = 4
_sum$ = -8						; size = 4
_array$ = 8						; size = 4
_size$ = 12						; size = 4
?findAverage@@YAMQBHH@Z PROC				; findAverage, COMDAT
...
; 80   : 
; 81   : 	float sum = 0;   // holds the sum of all the numbers

	xorps	xmm0, xmm0
	movss	DWORD PTR _sum$[ebp], xmm0

; 82   : 
; 83   : 	for (int pos = 0; pos < size; pos++)

	mov	DWORD PTR _pos$1[ebp], 0
	jmp	SHORT $LN4@findAverag
$LN2@findAverag:
...
$LN4@findAverag:
	mov	eax, DWORD PTR _pos$1[ebp]
	cmp	eax, DWORD PTR _size$[ebp]
	jge	SHORT $LN3@findAverag

; 84   : 			sum = sum + array[pos];

	mov	eax, DWORD PTR _pos$1[ebp]
	mov	ecx, DWORD PTR _array$[ebp]
	cvtsi2ss xmm0, DWORD PTR [ecx+eax*4]
	addss	xmm0, DWORD PTR _sum$[ebp]
	movss	DWORD PTR _sum$[ebp], xmm0
	jmp	SHORT $LN2@findAverag
$LN3@findAverag:

; 85   : 
; 86   : 	return (sum / size);  //returns the average

	cvtsi2ss xmm0, DWORD PTR _size$[ebp]
	movss	xmm1, DWORD PTR _sum$[ebp]
	divss	xmm1, xmm0
	movss	DWORD PTR tv82[ebp], xmm1
...
; 88   : }
	...
	pop	ebp
	ret	0
?findAverage@@YAMQBHH@Z ENDP				; findAverage
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
