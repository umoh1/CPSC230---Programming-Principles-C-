; Listing generated by Microsoft (R) Optimizing Compiler Version 19.28.29336.0 
	...
	TITLE	C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch11Lab2.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__B2F2BD23_Ch11Lab2@cpp DB 01H
...
PUBLIC	??0taxPayer@@QAE@XZ				; taxPayer::taxPayer
PUBLIC	??1taxPayer@@QAE@XZ				; taxPayer::~taxPayer
PUBLIC	_main
...
PUBLIC	??_C@_0O@GNOCJJID@Tim?5McGuiness@		; `string'
PUBLIC	??_C@_09DPGGEHOD@John?5Kane@			; `string'
PUBLIC	??_C@_0CE@FFIMJNO@Please?5input?5the?5yearly?5income?5@ ; `string'
PUBLIC	??_C@_06GECNACHD@Name?3?5@			; `string'
PUBLIC	??_C@_0BJ@ICEEAONE@Social?5Security?5Number?3?5@ ; `string'
PUBLIC	??_C@_0BL@GCBBGBAL@Taxes?5due?5for?5this?5year?3?5$@ ; `string'
...
CONST	ENDS
;	COMDAT ??_C@_0BL@GCBBGBAL@Taxes?5due?5for?5this?5year?3?5$@
CONST	SEGMENT
??_C@_0BL@GCBBGBAL@Taxes?5due?5for?5this?5year?3?5$@ DB 'Taxes due for th'
	DB	'is year: $', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0BJ@ICEEAONE@Social?5Security?5Number?3?5@
CONST	SEGMENT
??_C@_0BJ@ICEEAONE@Social?5Security?5Number?3?5@ DB 'Social Security Numb'
	DB	'er: ', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_06GECNACHD@Name?3?5@
CONST	SEGMENT
??_C@_06GECNACHD@Name?3?5@ DB 'Name: ', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_0CE@FFIMJNO@Please?5input?5the?5yearly?5income?5@
CONST	SEGMENT
??_C@_0CE@FFIMJNO@Please?5input?5the?5yearly?5income?5@ DB 'Please input '
	DB	'the yearly income for ', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_09DPGGEHOD@John?5Kane@
CONST	SEGMENT
??_C@_09DPGGEHOD@John?5Kane@ DB 'John Kane', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0O@GNOCJJID@Tim?5McGuiness@
CONST	SEGMENT
??_C@_0O@GNOCJJID@Tim?5McGuiness@ DB 'Tim McGuiness', 00H ; `string'
CONST	ENDS
...
$T2 = -344						; size = 4
$T3 = -332						; size = 16
_citizen2$ = -116					; size = 44
_citizen1$ = -64					; size = 44
...
; 16   : {
	...
	lea	eax, DWORD PTR __$EHRec$[ebp]
	mov	DWORD PTR fs:0, eax
	mov	ecx, OFFSET __B2F2BD23_Ch11Lab2@cpp
	call	@__CheckForDebuggerJustMyCode@4

; 17   : 	// Fill in code to initialize a structure variable named citizen1 so that
; 18   : 	// the first three members are initilized.  Assume the name is Tim 
; 19   : 	// McGuiness,the social security number is 255871234, and the tax rate is .35
; 20   : 	taxPayer citizen1;

	lea	ecx, DWORD PTR _citizen1$[ebp]
	call	??0taxPayer@@QAE@XZ
	mov	DWORD PTR __$EHRec$[ebp+8], 0

; 21   : 
; 22   : 	citizen1.name = "Tim McGuiness";

	push	OFFSET ??_C@_0O@GNOCJJID@Tim?5McGuiness@
	lea	ecx, DWORD PTR _citizen1$[ebp]
...
; 23   : 	citizen1.socialSecNum = 255871234;

	mov	DWORD PTR _citizen1$[ebp+28], 255871234	; 0f404902H

; 24   : 	citizen1.taxRate = .35;

	movss	xmm0, DWORD PTR __real@3eb33333
	movss	DWORD PTR _citizen1$[ebp+32], xmm0

; 25   : 
; 26   : 	// Fill in code to initialize a structure variable named citizen2 so that 
; 27   : 	// the first three members are initialized.  Assume the name is John Kane,
; 28   : 	// the social security number is 278990582, and the tax rate is .29
; 29   : 
; 30   : 	taxPayer citizen2;

	lea	ecx, DWORD PTR _citizen2$[ebp]
	call	??0taxPayer@@QAE@XZ
	mov	BYTE PTR __$EHRec$[ebp+8], 1

; 31   : 	citizen2.name = "John Kane";

	push	OFFSET ??_C@_09DPGGEHOD@John?5Kane@
	lea	ecx, DWORD PTR _citizen2$[ebp]
	call	??4?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV01@QBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::operator=

; 32   : 	citizen2.socialSecNum = 278990582;

	mov	DWORD PTR _citizen2$[ebp+28], 278990582	; 10a10ef6H

; 33   : 	citizen2.taxRate = .29;

	movss	xmm0, DWORD PTR __real@3e947ae1
	movss	DWORD PTR _citizen2$[ebp+32], xmm0
...
; 36   : 
; 37   : 	// calculate taxes due for citizen1
; 38   : 	
; 39   : 	// Fill in code to prompt the user to enter this year's income for the citizen1
; 40   : 	cout << "Please input the yearly income for " << citizen1.name << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	lea	eax, DWORD PTR _citizen1$[ebp]
	push	eax
	push	OFFSET ??_C@_0CE@FFIMJNO@Please?5input?5the?5yearly?5income?5@
	mov	ecx, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	ecx
...
; 41   : 	cin >> citizen1.income;

	mov	esi, esp
	lea	eax, DWORD PTR _citizen1$[ebp+36]
	push	eax
...
; 42   : 	// Fill in code to read in this income to the appropriate structure member
; 43   : 
; 44   : 	// Fill in code to determine this year's taxes for citizen1
; 45   : 	citizen1.taxes = citizen1.taxRate * citizen1.income;

	movss	xmm0, DWORD PTR _citizen1$[ebp+32]
	mulss	xmm0, DWORD PTR _citizen1$[ebp+36]
	movss	DWORD PTR _citizen1$[ebp+40], xmm0

; 46   : 
; 47   : 	cout << "Name: " << citizen1.name << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	lea	eax, DWORD PTR _citizen1$[ebp]
	push	eax
	push	OFFSET ??_C@_06GECNACHD@Name?3?5@
	mov	ecx, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	ecx
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
...
; 48   : 	cout << "Social Security Number: " << citizen1.socialSecNum << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	mov	edi, esp
	mov	eax, DWORD PTR _citizen1$[ebp+28]
	push	eax
	push	OFFSET ??_C@_0BJ@ICEEAONE@Social?5Security?5Number?3?5@
	mov	ecx, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	ecx
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
...
; 49   : 
; 50   : 	cout << "Taxes due for this year: $" << citizen1.taxes << endl << endl;
	...
	mov	ebx, esp
	push	ecx
	movss	xmm0, DWORD PTR _citizen1$[ebp+40]
	movss	DWORD PTR [esp], xmm0
	push	OFFSET ??_C@_0BL@GCBBGBAL@Taxes?5due?5for?5this?5year?3?5$@
...
; 51   : 
; 52   : 	// calculate taxes due for citizen2
; 53   : 
; 54   : 	// FILL IN CODE to prompt the user to enter this year's income for citizen2
; 55   : 	// FILL IN CODE to read in this income to the appropriate structure member
; 56   : 
; 57   : 	// FILL IN CODE to determine this year's taxes for citizen2
; 58   : 
; 59   : 	cout << "Please input the yearly income for " << citizen2.name << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	lea	eax, DWORD PTR _citizen2$[ebp]
	push	eax
	push	OFFSET ??_C@_0CE@FFIMJNO@Please?5input?5the?5yearly?5income?5@
	mov	ecx, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	ecx
...
; 60   : 	cin >> citizen2.income;

	mov	esi, esp
	lea	eax, DWORD PTR _citizen2$[ebp+36]
	push	eax
	mov	ecx, DWORD PTR __imp_?cin@std@@3V?$basic_istream@DU?$char_traits@D@std@@@1@A
	call	DWORD PTR __imp_??5?$basic_istream@DU?$char_traits@D@std@@@std@@QAEAAV01@AAM@Z
	cmp	esi, esp
...
; 61   : 
; 62   : 	citizen2.taxes = citizen2.taxRate * citizen2.income;

	movss	xmm0, DWORD PTR _citizen2$[ebp+32]
	mulss	xmm0, DWORD PTR _citizen2$[ebp+36]
	movss	DWORD PTR _citizen2$[ebp+40], xmm0

; 63   : 
; 64   : 	cout << "Name: " << citizen2.name << endl;
...
; 65   : 	cout << "Social Security Number: " << citizen2.socialSecNum << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	mov	edi, esp
	mov	eax, DWORD PTR _citizen2$[ebp+28]
	push	eax
	push	OFFSET ??_C@_0BJ@ICEEAONE@Social?5Security?5Number?3?5@
	mov	ecx, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	ecx
...
; 66   : 
; 67   : 	cout << "Taxes due for this year: $" << citizen2.taxes << endl << endl;
	...
	mov	ebx, esp
	push	ecx
	movss	xmm0, DWORD PTR _citizen2$[ebp+40]
	movss	DWORD PTR [esp], xmm0
	push	OFFSET ??_C@_0BL@GCBBGBAL@Taxes?5due?5for?5this?5year?3?5$@
	mov	eax, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	eax
...
_main	ENDP
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ??1taxPayer@@QAE@XZ
_TEXT	SEGMENT
_this$ = -8						; size = 4
??1taxPayer@@QAE@XZ PROC				; taxPayer::~taxPayer, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
	...
	pop	ebp
	ret	0
??1taxPayer@@QAE@XZ ENDP				; taxPayer::~taxPayer
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ??0taxPayer@@QAE@XZ
_TEXT	SEGMENT
_this$ = -8						; size = 4
??0taxPayer@@QAE@XZ PROC				; taxPayer::taxPayer, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
	...
	pop	ebp
	ret	0
??0taxPayer@@QAE@XZ ENDP				; taxPayer::taxPayer
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
