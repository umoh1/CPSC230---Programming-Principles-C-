...
;	COMDAT xdata$x
xdata$x	SEGMENT
__unwindtable$?PrintList@SortedList@@QAEXXZ DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?PrintList@SortedList@@QAEXXZ$0
__ehfuncinfo$?PrintList@SortedList@@QAEXXZ DD 019930522H
	DD	01H
	DD	FLAT:__unwindtable$?PrintList@SortedList@@QAEXXZ
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
...
; 46   : {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$?PrintList@SortedList@@QAEXXZ
	mov	eax, DWORD PTR fs:0
	push	eax
...
$LN7@PrintList:
	...
	cmp	ecx, DWORD PTR [eax]
	jge	SHORT $LN6@PrintList

; 53   : 		{
; 54   : 			if (values[j] > lowest)

	lea	eax, DWORD PTR _lowest$[ebp]
	push	eax
	imul	ecx, DWORD PTR _j$3[ebp], 28
	mov	edx, DWORD PTR _this$[ebp]
	lea	eax, DWORD PTR [edx+ecx+4]
	push	eax
	...
	movzx	ecx, al
	test	ecx, ecx
	je	SHORT $LN11@PrintList

; 55   : 			{
; 56   : 				lowest = values[j];

	imul	eax, DWORD PTR _j$3[ebp], 28
	mov	ecx, DWORD PTR _this$[ebp]
...
; 57   : values[i] = lowest;
	...
	lea	eax, DWORD PTR _lowest$[ebp]
	push	eax
	imul	ecx, DWORD PTR _i$4[ebp], 28
	mov	edx, DWORD PTR _this$[ebp]
...
; 63   : 	if (length > 0)
	...
	mov	eax, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [eax], 0
	jle	SHORT $LN12@PrintList

; 64   : 	{
; 65   : 		for (int i = 0; i < length; i++)

	mov	DWORD PTR _i$2[ebp], 0
	jmp	SHORT $LN10@PrintList
$LN8@PrintList:
...
$LN10@PrintList:
	...
	cmp	ecx, DWORD PTR [eax]
	jge	SHORT $LN9@PrintList

; 66   : 		{
; 67   : 			cout << values[i] << endl;
...
; 68   : 		}
	...
	jmp	SHORT $LN8@PrintList
$LN9@PrintList:

; 69   : 	}

	jmp	SHORT $LN13@PrintList
$LN12@PrintList:

; 70   : 	else
; 71   : 	{
; 72   : 		cout << "List is empty. Cannot print to screen." << endl;
...
; 74   : }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN19@PrintList
	call	@_RTC_CheckStackVars@8
	pop	eax
	pop	edx
	mov	ecx, DWORD PTR __$EHRec$[ebp]
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$?PrintList@SortedList@@QAEXXZ$0:
	lea	ecx, DWORD PTR _lowest$[ebp]
	...
	int	3
	int	3
__ehhandler$?PrintList@SortedList@@QAEXXZ:
	npad	1
	npad	1
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	...
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?PrintList@SortedList@@QAEXXZ
	jmp	___CxxFrameHandler3
text$x	ENDS
