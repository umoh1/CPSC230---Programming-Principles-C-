; Listing generated by Microsoft (R) Optimizing Compiler Version 19.28.29336.0 
	...
	TITLE	C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\8p1lab.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?searchList@@YAHQAHHH@Z				; searchList
PUBLIC	_main
...
PUBLIC	??_C@_0CG@IPMDMJHE@C?3?2Users?2nsika?2Downloads?2gradfi@ ; `string'
PUBLIC	??_C@_0CH@ODIHLNKF@The?5grades?5read?5in?5from?5the?5fil@ ; `string'
PUBLIC	??_C@_0DD@EGFINHIA@Enter?5a?5number?5to?5search?5for?3?5e@ ; `string'
PUBLIC	??_C@_0BL@MNNGPMAP@?5was?5not?5found?5in?5the?5list@ ; `string'
PUBLIC	??_C@_0M@GNPIIAI@The?5number?5@			; `string'
PUBLIC	??_C@_0BG@KLNGAHIP@?5position?5of?5the?5list@	; `string'
PUBLIC	??_C@_0M@BCNEMLHJ@?5is?5in?5the?5@		; `string'
...
CONST	ENDS
;	COMDAT ??_C@_0M@BCNEMLHJ@?5is?5in?5the?5@
CONST	SEGMENT
??_C@_0M@BCNEMLHJ@?5is?5in?5the?5@ DB ' is in the ', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BG@KLNGAHIP@?5position?5of?5the?5list@
CONST	SEGMENT
??_C@_0BG@KLNGAHIP@?5position?5of?5the?5list@ DB ' position of the list', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0M@GNPIIAI@The?5number?5@
CONST	SEGMENT
??_C@_0M@GNPIIAI@The?5number?5@ DB 'The number ', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0BL@MNNGPMAP@?5was?5not?5found?5in?5the?5list@
CONST	SEGMENT
??_C@_0BL@MNNGPMAP@?5was?5not?5found?5in?5the?5list@ DB ' was not found i'
	DB	'n the list', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0DD@EGFINHIA@Enter?5a?5number?5to?5search?5for?3?5e@
CONST	SEGMENT
??_C@_0DD@EGFINHIA@Enter?5a?5number?5to?5search?5for?3?5e@ DB 'Enter a nu'
	DB	'mber to search for: enter -99999 to exit', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0CH@ODIHLNKF@The?5grades?5read?5in?5from?5the?5fil@
CONST	SEGMENT
??_C@_0CH@ODIHLNKF@The?5grades?5read?5in?5from?5the?5fil@ DB 'The grades '
	DB	'read in from the file are: ', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_0CG@IPMDMJHE@C?3?2Users?2nsika?2Downloads?2gradfi@
CONST	SEGMENT
??_C@_0CG@IPMDMJHE@C?3?2Users?2nsika?2Downloads?2gradfi@ DB 'C:\Users\nsi'
	DB	'ka\Downloads\gradfile.txt', 00H		; `string'
CONST	ENDS
...
; 13   : {
	...
	lea	eax, DWORD PTR __$EHRec$[ebp]
	mov	DWORD PTR fs:0, eax
	mov	ecx, OFFSET __D2E2739C_8p1lab@cpp
	call	@__CheckForDebuggerJustMyCode@4

; 14   : 	int nums[SIZE];
; 15   : 	int found;
; 16   : 	int num;
; 17   : 	ifstream gradeFile;

	push	184					; 000000b8H
	lea	ecx, DWORD PTR _gradeFile$[ebp]
...
; 18   : 	gradeFile.open("C:\\Users\\nsika\\Downloads\\gradfile.txt");

	push	64					; 00000040H
	push	1
	push	OFFSET ??_C@_0CG@IPMDMJHE@C?3?2Users?2nsika?2Downloads?2gradfi@
	lea	ecx, DWORD PTR _gradeFile$[ebp]
...
; 23   : 	{	
; 24   : 		cout << "The grades read in from the file are: " << num << endl;
	...
	push	eax
	push	OFFSET ??_C@_0CH@ODIHLNKF@The?5grades?5read?5in?5from?5the?5fil@
...
; 25   : 		nums[i] = num;
	...
	mov	DWORD PTR _nums$[ebp+eax*4], ecx
...
; 30   : 	{
; 31   : 
; 32   : 		cout << "Enter a number to search for: enter -99999 to exit" << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0DD@EGFINHIA@Enter?5a?5number?5to?5search?5for?3?5e@
...
; 34   : 
; 35   : 		found = searchList(nums, i, num);

	mov	eax, DWORD PTR _num$[ebp]
	push	eax
	mov	ecx, DWORD PTR _i$[ebp]
	push	ecx
	lea	edx, DWORD PTR _nums$[ebp]
	push	edx
	call	?searchList@@YAHQAHHH@Z			; searchList
	add	esp, 12					; 0000000cH
...
; 37   : 			cout << "The number " << num

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0BL@MNNGPMAP@?5was?5not?5found?5in?5the?5list@
	mov	edi, esp
	mov	eax, DWORD PTR _num$[ebp]
	push	eax
	push	OFFSET ??_C@_0M@GNPIIAI@The?5number?5@
	mov	ecx, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	ecx
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
...
; 38   : 			<< " was not found in the list" << endl;
; 39   : 		else
; 40   : 			cout << "The number " << num << " is in the " << found + 1

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0BG@KLNGAHIP@?5position?5of?5the?5list@
	mov	eax, DWORD PTR _found$[ebp]
	add	eax, 1
	mov	edi, esp
	push	eax
	push	OFFSET ??_C@_0M@BCNEMLHJ@?5is?5in?5the?5@
	mov	ebx, esp
	mov	ecx, DWORD PTR _num$[ebp]
	push	ecx
	push	OFFSET ??_C@_0M@GNPIIAI@The?5number?5@
...
; 41   : 			<< " position of the list" << endl;
; 42   : 	} while (num!=-99999);

	cmp	DWORD PTR _num$[ebp], -99999		; fffe7961H
	jne	$LN6@main
...
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\8p1lab.cpp
;	COMDAT ?searchList@@YAHQAHHH@Z
_TEXT	SEGMENT
_count$1 = -8						; size = 4
_List$ = 8						; size = 4
_numElems$ = 12						; size = 4
_value$ = 16						; size = 4
?searchList@@YAHQAHHH@Z PROC				; searchList, COMDAT
...
; 61   : 	for (int count = 0; count <= numElems; count++)
...
$LN4@searchList:
	...
	jg	SHORT $LN3@searchList

; 62   : 	{
; 63   : 		if (List[count] == value)

	mov	eax, DWORD PTR _count$1[ebp]
	mov	ecx, DWORD PTR _List$[ebp]
	mov	edx, DWORD PTR [ecx+eax*4]
	cmp	edx, DWORD PTR _value$[ebp]
	jne	SHORT $LN5@searchList

; 64   : 			// each array entry is checked to see if it contains
; 65   : 			// the desired value.
; 66   : 			return count;

	mov	eax, DWORD PTR _count$1[ebp]
	jmp	SHORT $LN1@searchList
$LN5@searchList:

; 67   : 		// if the desired value is found, the array subscript
; 68   : 	 // count is returned to indicate the location in the array
; 69   : 	}

	jmp	SHORT $LN2@searchList
$LN3@searchList:

; 70   : 	return -1;	     // if the value is not found, -1 is returned
...
; 71   : }
	...
	pop	ebp
	ret	0
?searchList@@YAHQAHHH@Z ENDP				; searchList
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\VC\Tools\MSVC\14.28.29333\include\fstream
