...
; 97   : 
; 98   : 	cout << "There are " <<numItems <<" in the queue (front to rear)."<< endl;
...
; 99   : 	while (nodePtr != NULL)

	cmp	DWORD PTR _nodePtr$[ebp], 0
	je	SHORT $LN3@display

; 100  : 	{
; 101  : 		cout << nodePtr->value << endl;
...
; 64   : 	QueueNode* nodePtr = front;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR _nodePtr$[ebp], ecx

; 65   : 	QueueNode* newFront = nullptr;
...
; 71   : 	}
; 72   : 
; 73   : 	cout << front->value << " is removed." << endl;
...
; 74   : 	//set second node to new front
; 75   : 	newFront = front->next;
...
; 43   : 	}
	...
	jmp	SHORT $LN5@enqueue
$LN4@enqueue:

; 44   : 	else
; 45   : 	{
; 46   : 		//set nodePtr to front 
; 47   : 		nodePtr = front;
...
; 48   : 
; 49   : 		while (nodePtr!=NULL)

	cmp	DWORD PTR _nodePtr$[ebp], 0
	je	SHORT $LN3@enqueue

; 50   : 		{
; 51   : 			nodePtr = nodePtr->next;
...
; 53   : 
; 54   : 		//append new node and set rear
; 55   : 		nodePtr->next = newNode;
