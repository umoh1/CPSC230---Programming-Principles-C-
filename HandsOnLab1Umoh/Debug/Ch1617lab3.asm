; Listing generated by Microsoft (R) Optimizing Compiler Version 19.28.29336.0 
	...
	TITLE	C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch1617lab3.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__2D0BA043_Ch1617lab3@cpp DB 01H
...
PUBLIC	??$calcAbs@H@@YAHH@Z				; calcAbs<int>
PUBLIC	??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
PUBLIC	??$calcAbs@N@@YANN@Z				; calcAbs<double>
...
PUBLIC	??_C@_0CP@FKCCCMKK@How?5many?5integer?5values?5do?5you?5@ ; `string'
PUBLIC	??_C@_0BA@EDHCNGJP@Enter?5a?5value?3?5@		; `string'
PUBLIC	??_C@_0O@DADHEGOJ@The?5total?5is?5@		; `string'
PUBLIC	??_C@_0CN@CNIJDDGI@How?5many?5double?5values?5do?5you?5w@ ; `string'
EXTRN	_abs:PROC
EXTRN	_fabs:PROC
EXTRN	_strlen:PROC
...
rtc$IMZ	ENDS
;	COMDAT ??_C@_0CN@CNIJDDGI@How?5many?5double?5values?5do?5you?5w@
CONST	SEGMENT
??_C@_0CN@CNIJDDGI@How?5many?5double?5values?5do?5you?5w@ DB 'How many do'
	DB	'uble values do you wish to total?', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0O@DADHEGOJ@The?5total?5is?5@
CONST	SEGMENT
??_C@_0O@DADHEGOJ@The?5total?5is?5@ DB 'The total is ', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BA@EDHCNGJP@Enter?5a?5value?3?5@
CONST	SEGMENT
??_C@_0BA@EDHCNGJP@Enter?5a?5value?3?5@ DB 'Enter a value: ', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0CP@FKCCCMKK@How?5many?5integer?5values?5do?5you?5@
CONST	SEGMENT
??_C@_0CP@FKCCCMKK@How?5many?5integer?5values?5do?5you?5@ DB 'How many in'
	DB	'teger values do you wish to total? ', 00H	; `string'
CONST	ENDS
;	COMDAT xdata$x
xdata$x	SEGMENT
...
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch1617lab3.cpp
;	COMDAT ??$calcAbs@N@@YANN@Z
_TEXT	SEGMENT
_num$ = 8						; size = 8
??$calcAbs@N@@YANN@Z PROC				; calcAbs<double>, COMDAT
...
; 7    : {
	...
	mov	eax, -858993460				; ccccccccH
	rep stosd
	mov	ecx, OFFSET __2D0BA043_Ch1617lab3@cpp
	call	@__CheckForDebuggerJustMyCode@4
...
; 9    : }
	...
	pop	ebp
	ret	0
??$calcAbs@N@@YANN@Z ENDP				; calcAbs<double>
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\VC\Tools\MSVC\14.28.29333\include\ostream
...
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch1617lab3.cpp
;	COMDAT ??$calcAbs@H@@YAHH@Z
_TEXT	SEGMENT
_num$ = 8						; size = 4
??$calcAbs@H@@YAHH@Z PROC				; calcAbs<int>, COMDAT
...
; 9    : }
	...
	pop	ebp
	ret	0
??$calcAbs@H@@YAHH@Z ENDP				; calcAbs<int>
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\VC\Tools\MSVC\14.28.29333\include\ostream
...
; 13   : 	int totalInt =0, totalDob=0;

	mov	DWORD PTR _totalInt$[ebp], 0
	mov	DWORD PTR _totalDob$[ebp], 0

; 14   : 
; 15   : 	cout << "How many integer values do you wish to total? ";

	push	OFFSET ??_C@_0CP@FKCCCMKK@How?5many?5integer?5values?5do?5you?5@
...
; 16   : 	cin >> totalInt;
	...
	mov	esi, esp
	lea	eax, DWORD PTR _totalInt$[ebp]
	push	eax
...
; 19   : 	double sum1 =0.0;
	...
	xorps	xmm0, xmm0
	movsd	QWORD PTR _sum1$[ebp], xmm0
...
$LN4@main:
	mov	eax, DWORD PTR _i$2[ebp]
	cmp	eax, DWORD PTR _totalInt$[ebp]
	jge	SHORT $LN3@main

; 24   : 	{
; 25   : 		cout << "Enter a value: ";

	push	OFFSET ??_C@_0BA@EDHCNGJP@Enter?5a?5value?3?5@
	mov	eax, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	eax
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
...
; 27   : 		sum+=calcAbs(num);
	...
	mov	eax, DWORD PTR _num$[ebp]
	push	eax
	call	??$calcAbs@H@@YAHH@Z			; calcAbs<int>
	add	esp, 4
...
; 30   : 
; 31   : 	cout << endl<< "The total is " << sum << endl;
	...
	push	eax
	push	OFFSET ??_C@_0O@DADHEGOJ@The?5total?5is?5@
	mov	ebx, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
...
; 32   : 
; 33   : 	cout << endl<<"How many double values do you wish to total?";

	push	OFFSET ??_C@_0CN@CNIJDDGI@How?5many?5double?5values?5do?5you?5w@
	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	mov	ecx, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	call	DWORD PTR __imp_??6?$basic_ostream@DU?$char_traits@D@std@@@std@@QAEAAV01@P6AAAV01@AAV01@@Z@Z
...
; 34   : 	cin >> totalDob;
	...
	mov	esi, esp
	lea	eax, DWORD PTR _totalDob$[ebp]
	push	eax
	mov	ecx, DWORD PTR __imp_?cin@std@@3V?$basic_istream@DU?$char_traits@D@std@@@1@A
	call	DWORD PTR __imp_??5?$basic_istream@DU?$char_traits@D@std@@@std@@QAEAAV01@AAH@Z
	cmp	esi, esp
...
$LN7@main:
	mov	eax, DWORD PTR _i$1[ebp]
	cmp	eax, DWORD PTR _totalDob$[ebp]
	jge	SHORT $LN6@main

; 37   : 	{
; 38   : 		cout << "Enter a value: ";
...
; 40   : 		sum1 += calcAbs(num1);

	sub	esp, 8
	movsd	xmm0, QWORD PTR _num1$[ebp]
	movsd	QWORD PTR [esp], xmm0
	call	??$calcAbs@N@@YANN@Z			; calcAbs<double>
	add	esp, 8
	fstp	QWORD PTR tv189[ebp]
	movsd	xmm0, QWORD PTR tv189[ebp]
	addsd	xmm0, QWORD PTR _sum1$[ebp]
	movsd	QWORD PTR _sum1$[ebp], xmm0
...
; 43   : 	cout << endl << "The total is " << sum1 << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	mov	edi, esp
	sub	esp, 8
	movsd	xmm0, QWORD PTR _sum1$[ebp]
	movsd	QWORD PTR [esp], xmm0
	push	OFFSET ??_C@_0O@DADHEGOJ@The?5total?5is?5@
	mov	ebx, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\VC\Tools\MSVC\14.28.29333\include\cstdlib
;	COMDAT ?abs@@YANN@Z
_TEXT	SEGMENT
__Xx$ = 8						; size = 8
?abs@@YANN@Z PROC					; abs, COMDAT

; 23   : _NODISCARD _Check_return_ inline double abs(_In_ double _Xx) noexcept /* strengthened */ {
	...
	mov	eax, -858993460				; ccccccccH
	rep stosd
	mov	ecx, OFFSET __ACEB72CA_cstdlib
	call	@__CheckForDebuggerJustMyCode@4
