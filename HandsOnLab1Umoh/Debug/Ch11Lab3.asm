; Listing generated by Microsoft (R) Optimizing Compiler Version 19.28.29336.0 
	...
	TITLE	C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch11Lab3.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__8F929493_Ch11Lab3@cpp DB 01H
...
PUBLIC	??_C@_0DP@GOJIHDK@Please?5enter?5the?5annual?5income?5@ ; `string'
PUBLIC	??_C@_0CI@GAIMBONN@Enter?5this?5year?8s?5income?5for?5ta@ ; `string'
PUBLIC	??_C@_0CE@JCHJEGGH@Enter?5the?5tax?5rate?5for?5tax?5paye@ ; `string'
PUBLIC	??_C@_0BK@PAHPDAIN@Taxes?5due?5for?5this?5year?3?5@ ; `string'
PUBLIC	??_C@_02KKHOOMHD@$?5@				; `string'
PUBLIC	??_C@_0N@ECIGFOFD@Tax?5Payer?5?$CD?5@		; `string'
...
CONST	ENDS
;	COMDAT ??_C@_0N@ECIGFOFD@Tax?5Payer?5?$CD?5@
CONST	SEGMENT
??_C@_0N@ECIGFOFD@Tax?5Payer?5?$CD?5@ DB 'Tax Payer # ', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_02KKHOOMHD@$?5@
CONST	SEGMENT
??_C@_02KKHOOMHD@$?5@ DB '$ ', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0BK@PAHPDAIN@Taxes?5due?5for?5this?5year?3?5@
CONST	SEGMENT
??_C@_0BK@PAHPDAIN@Taxes?5due?5for?5this?5year?3?5@ DB 'Taxes due for thi'
	DB	's year: ', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0CE@JCHJEGGH@Enter?5the?5tax?5rate?5for?5tax?5paye@
CONST	SEGMENT
??_C@_0CE@JCHJEGGH@Enter?5the?5tax?5rate?5for?5tax?5paye@ DB 'Enter the t'
	DB	'ax rate for tax payer # ', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_0CI@GAIMBONN@Enter?5this?5year?8s?5income?5for?5ta@
CONST	SEGMENT
??_C@_0CI@GAIMBONN@Enter?5this?5year?8s?5income?5for?5ta@ DB 'Enter this '
	DB	'year''s income for tax payer ', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_0DP@GOJIHDK@Please?5enter?5the?5annual?5income?5@
CONST	SEGMENT
??_C@_0DP@GOJIHDK@Please?5enter?5the?5annual?5income?5@ DB 'Please enter '
	DB	'the annual income and tax rate for 5 tax payers: ', 00H ; `string'
CONST	ENDS
...
; 18   : {
	...
	xor	eax, ebp
	mov	DWORD PTR __$ArrayPad$[ebp], eax
	mov	ecx, OFFSET __8F929493_Ch11Lab3@cpp
	call	@__CheckForDebuggerJustMyCode@4

; 19   : 	// Fill in code to declare an array named citizen which holds
; 20   : 	// 5 taxPayers structures
; 21   : 	taxPayer citizen[5];
; 22   : 
...
; 24   : 
; 25   : 	cout << "Please enter the annual income and tax rate for 5 tax payers: ";

	push	OFFSET ??_C@_0DP@GOJIHDK@Please?5enter?5the?5annual?5income?5@
...
; 27   : 
; 28   : 	for (int count = 0; count < 5; count++)
...
$LN4@main:
	cmp	DWORD PTR _count$3[ebp], 5
	jge	$LN3@main

; 29   : 	{
; 30   : 
; 31   : 		cout << "Enter this year's income for tax payer " << (count + 1);

	mov	eax, DWORD PTR _count$3[ebp]
	add	eax, 1
	mov	esi, esp
	push	eax
	push	OFFSET ??_C@_0CI@GAIMBONN@Enter?5this?5year?8s?5income?5for?5ta@
	mov	ecx, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	ecx
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
...
; 33   : 
; 34   : 		// Fill in code to read in the income to the appropriate place
; 35   : 		cin >> citizen[count].income;

	imul	eax, DWORD PTR _count$3[ebp], 12
	lea	ecx, DWORD PTR _citizen$[ebp+eax+4]
	mov	esi, esp
	push	ecx
...
; 36   : 
; 37   : 		cout << "Enter the tax rate for tax payer # " << (count + 1);

	mov	eax, DWORD PTR _count$3[ebp]
	add	eax, 1
	mov	esi, esp
	push	eax
	push	OFFSET ??_C@_0CE@JCHJEGGH@Enter?5the?5tax?5rate?5for?5tax?5paye@
	mov	ecx, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	ecx
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
...
; 39   : 		cin >> citizen[count].taxRate;

	imul	eax, DWORD PTR _count$3[ebp], 12
	lea	ecx, DWORD PTR _citizen$[ebp+eax]
	mov	esi, esp
	push	ecx
	mov	ecx, DWORD PTR __imp_?cin@std@@3V?$basic_istream@DU?$char_traits@D@std@@@1@A
	call	DWORD PTR __imp_??5?$basic_istream@DU?$char_traits@D@std@@@std@@QAEAAV01@AAM@Z
...
; 44   : 
; 45   : 	cout << "Taxes due for this year: " << endl << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	mov	edi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0BK@PAHPDAIN@Taxes?5due?5for?5this?5year?3?5@
	mov	eax, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	eax
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
...
; 46   : 
; 47   : 	// Fill in code for the first line of a loop that will output the 
; 48   : 	// tax information
; 49   : 	for(int index = 0; index<5; index++)
...
$LN7@main:
	cmp	DWORD PTR _index$2[ebp], 5
	jge	$LN6@main

; 50   : 	{
; 51   : 		citizen[index].taxes = citizen[index].income * citizen[index].taxRate;

	imul	eax, DWORD PTR _index$2[ebp], 12
	imul	ecx, DWORD PTR _index$2[ebp], 12
	movss	xmm0, DWORD PTR _citizen$[ebp+eax+4]
	mulss	xmm0, DWORD PTR _citizen$[ebp+ecx]
	imul	edx, DWORD PTR _index$2[ebp], 12
	movss	DWORD PTR _citizen$[ebp+edx+8], xmm0

; 52   : 
; 53   : 		cout << "Tax Payer # " << (index + 1) << ": " << "$ "
	...
	mov	edi, esp
	push	ecx
	movss	xmm0, DWORD PTR _citizen$[ebp+eax+8]
	movss	DWORD PTR [esp], xmm0
	push	OFFSET ??_C@_02KKHOOMHD@$?5@
	push	OFFSET ??_C@_02LMMGGCAJ@?3?5@
	mov	ecx, DWORD PTR _index$2[ebp]
	add	ecx, 1
	mov	ebx, esp
	push	ecx
	push	OFFSET ??_C@_0N@ECIGFOFD@Tax?5Payer?5?$CD?5@
