; Listing generated by Microsoft (R) Optimizing Compiler Version 19.28.29336.0 
	...
	TITLE	C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch9lab4scoretable.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__C98DAB7E_Ch9lab4scoretable@cpp DB 01H
...
PUBLIC	?average@@YANQAHH@Z				; average
...
PUBLIC	??_C@_0CM@OKDGALJD@Enter?5the?5number?5of?5scores?5to?5b@ ; `string'
PUBLIC	??_C@_0BH@NAHFHAPN@Please?5enter?5a?5score?3?5@	; `string'
PUBLIC	??_C@_0CI@DPDAIHPL@Here?5are?5the?5scores?5in?5ascendin@ ; `string'
...
rtc$IMZ	ENDS
;	COMDAT ??_C@_0CI@DPDAIHPL@Here?5are?5the?5scores?5in?5ascendin@
CONST	SEGMENT
??_C@_0CI@DPDAIHPL@Here?5are?5the?5scores?5in?5ascendin@ DB 'Here are the'
	DB	' scores in ascending order:', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_0BH@NAHFHAPN@Please?5enter?5a?5score?3?5@
CONST	SEGMENT
??_C@_0BH@NAHFHAPN@Please?5enter?5a?5score?3?5@ DB 'Please enter a score:'
	DB	' ', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0CM@OKDGALJD@Enter?5the?5number?5of?5scores?5to?5b@
CONST	SEGMENT
??_C@_0CM@OKDGALJD@Enter?5the?5number?5of?5scores?5to?5b@ DB 'Enter the n'
	DB	'umber of scores to be inputted: ', 00H	; `string'
CONST	ENDS
;	COMDAT xdata$x
xdata$x	SEGMENT
...
; 9    : {
	...
	xor	eax, ebp
	mov	DWORD PTR __$ArrayPad$[ebp], eax
	mov	ecx, OFFSET __C98DAB7E_Ch9lab4scoretable@cpp
	call	@__CheckForDebuggerJustMyCode@4

; 10   : 	int* scores;
; 11   : 	int number;
; 12   : 
; 13   : 	cout << "Enter the number of scores to be inputted: "<<endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0CM@OKDGALJD@Enter?5the?5number?5of?5scores?5to?5b@
...
; 19   : 	{
; 20   : 		cout << "Please enter a score: " << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0BH@NAHFHAPN@Please?5enter?5a?5score?3?5@
	mov	eax, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	eax
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
...
; 23   : 
; 24   : 	average(scores, number);

	mov	eax, DWORD PTR _number$[ebp]
	push	eax
	mov	ecx, DWORD PTR _scores$[ebp]
	push	ecx
	call	?average@@YANQAHH@Z			; average
	fstp	ST(0)
	add	esp, 8

; 25   : 	bubbleSort(scores, number);
...
; 26   : 	cout << "Here are the scores in ascending order:" << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0CI@DPDAIHPL@Here?5are?5the?5scores?5in?5ascendin@
	mov	eax, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	eax
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
...
; 44   : 	for (int count = 0; count < elems; count++)
...
; 53   : 	bool swap;
; 54   : 	int temp;
; 55   : 	int bottom = elems - 1;     // bottom indicates the end part of the 
...
; 56   : 								// array where the largest values have
; 57   : 								// settled in order
; 58   : 	do
; 59   : 	{
; 60   : 		swap = false;
...
; 61   : 		for (int count = 0; count < bottom; count++)
...
; 62   : 		{
; 63   : 			if (array[count] > array[count + 1])
...
; 64   : 			{	          // the next three lines do a swap   
; 65   : 				temp = array[count];
...
; 68   : 				swap = true; // indicates that a swap occurred
...
; 71   : 		bottom--;     // bottom is decremented by 1 since each pass through

	mov	eax, DWORD PTR _bottom$[ebp]
	sub	eax, 1
	mov	DWORD PTR _bottom$[ebp], eax

; 72   : 					// the array adds one more value that is set in order
; 73   : 
; 74   : 	} while (swap != false);
...
; 75   : 	// loop repeats until a pass through the array with
; 76   :   // no swaps occurs
; 77   : }
...
_tArray$ = 8						; size = 4
_num$ = 12						; size = 4
?average@@YANQAHH@Z PROC				; average, COMDAT
...
; 39   : 	return sum / num;
	...
	cvtsi2sd xmm0, DWORD PTR _num$[ebp]
...
; 40   : }
	...
	pop	ebp
	ret	0
?average@@YANQAHH@Z ENDP				; average
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
