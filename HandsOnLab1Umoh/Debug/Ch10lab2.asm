; Listing generated by Microsoft (R) Optimizing Compiler Version 19.28.29336.0 
	...
	TITLE	C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch10lab2.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__5CFFCB36_Ch10lab2@cpp DB 01H
...
PUBLIC	??_C@_03HEBHPDAJ@?5?$DP?3@			; `string'
PUBLIC	??_C@_0BM@IBLJNEE@?5spend?5on?5food?5during?5week?5@ ; `string'
PUBLIC	??_C@_0CJ@MOHNAHFP@How?5much?5?$CIto?5the?5nearest?5dollar@ ; `string'
PUBLIC	??_C@_0DB@OPJOCOGM@Your?5weekly?5food?5bill?5over?5the?5@ ; `string'
PUBLIC	??_C@_0DG@KHDNPCOL@Would?5you?5like?5to?5find?5the?5aver@ ; `string'
PUBLIC	??_C@_0N@PCFOEGCB@Enter?5Y?5or?5N@		; `string'
...
CONST	ENDS
;	COMDAT ??_C@_0N@PCFOEGCB@Enter?5Y?5or?5N@
CONST	SEGMENT
??_C@_0N@PCFOEGCB@Enter?5Y?5or?5N@ DB 'Enter Y or N', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0DG@KHDNPCOL@Would?5you?5like?5to?5find?5the?5aver@
CONST	SEGMENT
??_C@_0DG@KHDNPCOL@Would?5you?5like?5to?5find?5the?5aver@ DB 'Would you l'
	DB	'ike to find the average for another month?', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0DB@OPJOCOGM@Your?5weekly?5food?5bill?5over?5the?5@
CONST	SEGMENT
??_C@_0DB@OPJOCOGM@Your?5weekly?5food?5bill?5over?5the?5@ DB 'Your weekly'
	DB	' food bill over the chosen month is $', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0CJ@MOHNAHFP@How?5much?5?$CIto?5the?5nearest?5dollar@
CONST	SEGMENT
??_C@_0CJ@MOHNAHFP@How?5much?5?$CIto?5the?5nearest?5dollar@ DB 'How much '
	DB	'(to the nearest dollar) did you', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0BM@IBLJNEE@?5spend?5on?5food?5during?5week?5@
CONST	SEGMENT
??_C@_0BM@IBLJNEE@?5spend?5on?5food?5during?5week?5@ DB ' spend on food d'
	DB	'uring week ', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_03HEBHPDAJ@?5?$DP?3@
CONST	SEGMENT
??_C@_03HEBHPDAJ@?5?$DP?3@ DB ' ?:', 00H		; `string'
CONST	ENDS
...
; 7    : {
	...
	xor	eax, ebp
	mov	DWORD PTR __$ArrayPad$[ebp], eax
	mov	ecx, OFFSET __5CFFCB36_Ch10lab2@cpp
	call	@__CheckForDebuggerJustMyCode@4

; 8    : 	int week, total, dollars;
; 9    : 	float average;
; 10   : 	char choice;
; 11   : 
; 12   : 	cout << showpoint << fixed << setprecision(2);
...
; 17   : 		for (week = 1; week <= 4; week++)

	mov	DWORD PTR _week$[ebp], 1
	jmp	SHORT $LN7@main
$LN5@main:
	mov	eax, DWORD PTR _week$[ebp]
	add	eax, 1
	mov	DWORD PTR _week$[ebp], eax
$LN7@main:
	cmp	DWORD PTR _week$[ebp], 4
	jg	$LN6@main

; 18   : 		{
; 19   : 			cout << "How much (to the nearest dollar) did you"

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_03HEBHPDAJ@?5?$DP?3@
	mov	edi, esp
	mov	eax, DWORD PTR _week$[ebp]
	push	eax
	push	OFFSET ??_C@_0BM@IBLJNEE@?5spend?5on?5food?5during?5week?5@
	push	OFFSET ??_C@_0CJ@MOHNAHFP@How?5much?5?$CIto?5the?5nearest?5dollar@
	mov	ecx, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	ecx
...
; 20   : 				<< " spend on food during week " << week << " ?:" << endl;
; 21   : 			cin >> dollars;

	mov	esi, esp
	lea	eax, DWORD PTR _dollars$[ebp]
	push	eax
...
; 22   : 
; 23   : 			total = total + dollars;

	mov	eax, DWORD PTR _total$[ebp]
	add	eax, DWORD PTR _dollars$[ebp]
...
; 25   : 		average = total / 4.0;

	cvtsi2sd xmm0, DWORD PTR _total$[ebp]
	divsd	xmm0, QWORD PTR __real@4010000000000000
	cvtsd2ss xmm0, xmm0
	movss	DWORD PTR _average$[ebp], xmm0

; 26   : 
; 27   : 		cout << "Your weekly food bill over the chosen month is $"
	...
	push	OFFSET ??_C@_0DB@OPJOCOGM@Your?5weekly?5food?5bill?5over?5the?5@
...
; 33   : 		{
; 34   : 
; 35   : 			cout << "Would you like to find the average for another month?";

	push	OFFSET ??_C@_0DG@KHDNPCOL@Would?5you?5like?5to?5find?5the?5aver@
	mov	eax, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	eax
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8

; 36   : 			cout << endl << "Enter Y or N" << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0N@PCFOEGCB@Enter?5Y?5or?5N@
	mov	edi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	mov	ecx, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	call	DWORD PTR __imp_??6?$basic_ostream@DU?$char_traits@D@std@@@std@@QAEAAV01@P6AAAV01@AAV01@@Z@Z
...
; 38   : 		}
; 39   : 		while (tolower(choice) != 'y' && tolower(choice) != 'n');
