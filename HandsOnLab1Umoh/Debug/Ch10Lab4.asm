; Listing generated by Microsoft (R) Optimizing Compiler Version 19.28.29336.0 
	...
	TITLE	C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch10Lab4.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__2AC95CC0_Ch10Lab4@cpp DB 01H
...
PUBLIC	??$strcat_s@$0BE@@@YAHAAY0BE@DPBD@Z		; strcat_s<20>
...
PUBLIC	??_C@_0P@NIOFCMAL@Total?5Eclipse?5@		; `string'
PUBLIC	??_C@_0L@HABLLKKC@of?5the?5Sun@			; `string'
...
rtc$IMZ	ENDS
;	COMDAT ??_C@_0L@HABLLKKC@of?5the?5Sun@
CONST	SEGMENT
??_C@_0L@HABLLKKC@of?5the?5Sun@ DB 'of the Sun', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0P@NIOFCMAL@Total?5Eclipse?5@
CONST	SEGMENT
??_C@_0P@NIOFCMAL@Total?5Eclipse?5@ DB 'Total Eclipse ', 00H ; `string'
CONST	ENDS
;	COMDAT xdata$x
xdata$x	SEGMENT
...
;	COMDAT ??$strcat_s@$0BE@@@YAHAAY0BE@DPBD@Z
_TEXT	SEGMENT
__Destination$ = 8					; size = 4
__Source$ = 12						; size = 4
??$strcat_s@$0BE@@@YAHAAY0BE@DPBD@Z PROC		; strcat_s<20>, COMDAT
...
; 83   : __DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_1(
	...
	mov	eax, -858993460				; ccccccccH
	rep stosd
	mov	ecx, OFFSET __32E5F013_string@h
	call	@__CheckForDebuggerJustMyCode@4
	mov	esi, esp
	...
	pop	ebp
	ret	0
??$strcat_s@$0BE@@@YAHAAY0BE@DPBD@Z ENDP		; strcat_s<20>
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\VC\Tools\MSVC\14.28.29333\include\ostream
...
; 5    : {
	...
	xor	eax, ebp
	mov	DWORD PTR __$ArrayPad$[ebp], eax
	mov	ecx, OFFSET __2AC95CC0_Ch10Lab4@cpp
	call	@__CheckForDebuggerJustMyCode@4

; 6    : 	char string1[20] = "Total Eclipse ";

	mov	eax, DWORD PTR ??_C@_0P@NIOFCMAL@Total?5Eclipse?5@
	mov	DWORD PTR _string1$[ebp], eax
	mov	ecx, DWORD PTR ??_C@_0P@NIOFCMAL@Total?5Eclipse?5@+4
	mov	DWORD PTR _string1$[ebp+4], ecx
	mov	edx, DWORD PTR ??_C@_0P@NIOFCMAL@Total?5Eclipse?5@+8
	mov	DWORD PTR _string1$[ebp+8], edx
	mov	ax, WORD PTR ??_C@_0P@NIOFCMAL@Total?5Eclipse?5@+12
	mov	WORD PTR _string1$[ebp+12], ax
	mov	cl, BYTE PTR ??_C@_0P@NIOFCMAL@Total?5Eclipse?5@+14
	mov	BYTE PTR _string1$[ebp+14], cl
	xor	eax, eax
	mov	DWORD PTR _string1$[ebp+15], eax
	mov	BYTE PTR _string1$[ebp+19], al

; 7    : 	char string2[11] = "of the Sun";

	mov	eax, DWORD PTR ??_C@_0L@HABLLKKC@of?5the?5Sun@
	mov	DWORD PTR _string2$[ebp], eax
	mov	ecx, DWORD PTR ??_C@_0L@HABLLKKC@of?5the?5Sun@+4
	mov	DWORD PTR _string2$[ebp+4], ecx
	mov	dx, WORD PTR ??_C@_0L@HABLLKKC@of?5the?5Sun@+8
	mov	WORD PTR _string2$[ebp+8], dx
	mov	al, BYTE PTR ??_C@_0L@HABLLKKC@of?5the?5Sun@+10
	mov	BYTE PTR _string2$[ebp+10], al
...
; 10   : 	strcat_s(string1, string2);

	lea	eax, DWORD PTR _string2$[ebp]
	push	eax
	lea	ecx, DWORD PTR _string1$[ebp]
	push	ecx
	call	??$strcat_s@$0BE@@@YAHAAY0BE@DPBD@Z	; strcat_s<20>
	add	esp, 8
