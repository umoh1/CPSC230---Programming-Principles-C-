; Listing generated by Microsoft (R) Optimizing Compiler Version 19.28.29336.0 
	...
	TITLE	C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch9Lab4yearlysales.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__9149A23A_Ch9Lab4yearlysales@cpp DB 01H
...
PUBLIC	?average@@YANQANH@Z				; average
PUBLIC	?sum@@YANQANH@Z					; sum
PUBLIC	_main
...
PUBLIC	??_C@_0DH@KPFANPFC@Please?5input?5the?5number?5of?5mont@ ; `string'
PUBLIC	??_C@_0CC@CJNBBCIH@Please?5input?5the?5sales?5for?5mont@ ; `string'
PUBLIC	??_C@_0CC@JNGGJGNJ@The?5total?5sales?5for?5the?5year?5is@ ; `string'
PUBLIC	??_C@_0BP@LAFKDMEA@The?5average?5monthly?5sale?5is?5$?5@ ; `string'
...
rtc$IMZ	ENDS
;	COMDAT ??_C@_0BP@LAFKDMEA@The?5average?5monthly?5sale?5is?5$?5@
CONST	SEGMENT
??_C@_0BP@LAFKDMEA@The?5average?5monthly?5sale?5is?5$?5@ DB 'The average '
	DB	'monthly sale is $ ', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0CC@JNGGJGNJ@The?5total?5sales?5for?5the?5year?5is@
CONST	SEGMENT
??_C@_0CC@JNGGJGNJ@The?5total?5sales?5for?5the?5year?5is@ DB 'The total s'
	DB	'ales for the year is $', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_0CC@CJNBBCIH@Please?5input?5the?5sales?5for?5mont@
CONST	SEGMENT
??_C@_0CC@CJNBBCIH@Please?5input?5the?5sales?5for?5mont@ DB 'Please input'
	DB	' the sales for month ', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0DH@KPFANPFC@Please?5input?5the?5number?5of?5mont@
CONST	SEGMENT
??_C@_0DH@KPFANPFC@Please?5input?5the?5number?5of?5mont@ DB 'Please input'
	DB	' the number of monthly sales to be input: ', 00H ; `string'
CONST	ENDS
;	COMDAT xdata$x
xdata$x	SEGMENT
...
; 8    : {
	...
	xor	eax, ebp
	mov	DWORD PTR __$ArrayPad$[ebp], eax
	mov	ecx, OFFSET __9149A23A_Ch9Lab4yearlysales@cpp
	call	@__CheckForDebuggerJustMyCode@4

; 9    : 	double* months;
; 10   : 	int number;
; 11   : 
; 12   : 	cout << "Please input the number of monthly sales to be input: " << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0DH@KPFANPFC@Please?5input?5the?5number?5of?5mont@
...
; 18   : 	{
; 19   : 		cout << "Please input the sales for month " << i +1 << endl;
	...
	mov	edi, esp
	push	eax
	push	OFFSET ??_C@_0CC@CJNBBCIH@Please?5input?5the?5sales?5for?5mont@
...
; 22   : 
; 23   : 	cout << "The total sales for the year is $" << sum(months, number)<< endl;
	...
	mov	ecx, DWORD PTR _months$[ebp]
	push	ecx
	call	?sum@@YANQANH@Z				; sum
	add	esp, 8
	mov	edi, esp
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET ??_C@_0CC@JNGGJGNJ@The?5total?5sales?5for?5the?5year?5is@
...
; 24   : 	cout << "The average monthly sale is $ "<< average(months, number) << endl;
	...
	mov	ecx, DWORD PTR _months$[ebp]
	push	ecx
	call	?average@@YANQANH@Z			; average
	add	esp, 8
	mov	edi, esp
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET ??_C@_0BP@LAFKDMEA@The?5average?5monthly?5sale?5is?5$?5@
	mov	edx, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	edx
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
...
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch9Lab4yearlysales.cpp
;	COMDAT ?sum@@YANQANH@Z
_TEXT	SEGMENT
_i$1 = -24						; size = 4
_sum$ = -12						; size = 8
_arrayW$ = 8						; size = 4
_number$ = 12						; size = 4
?sum@@YANQANH@Z PROC					; sum, COMDAT
...
; 37   : }
	...
	pop	ebp
	ret	0
?sum@@YANQANH@Z ENDP					; sum
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch9Lab4yearlysales.cpp
;	COMDAT ?average@@YANQANH@Z
_TEXT	SEGMENT
tv80 = -228						; size = 8
_i$1 = -24						; size = 4
_sum$ = -12						; size = 8
_arrayW$ = 8						; size = 4
_number$ = 12						; size = 4
?average@@YANQANH@Z PROC				; average, COMDAT
...
; 48   : 	return sum/number;
	...
	cvtsi2sd xmm0, DWORD PTR _number$[ebp]
	movsd	xmm1, QWORD PTR _sum$[ebp]
	divsd	xmm1, xmm0
	movsd	QWORD PTR tv80[ebp], xmm1
...
; 49   : }
	...
	pop	ebp
	ret	0
?average@@YANQANH@Z ENDP				; average
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
