; Listing generated by Microsoft (R) Optimizing Compiler Version 19.28.29336.0 
	...
	TITLE	C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch13lab4.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__EA320253_Ch13lab4@cpp DB 01H
...
PUBLIC	?getId@Inventory@@QAEXH@Z			; Inventory::getId
PUBLIC	?getAmount@Inventory@@QAEXH@Z			; Inventory::getAmount
PUBLIC	?display@Inventory@@QAEXXZ			; Inventory::display
PUBLIC	_main
...
PUBLIC	??_C@_0CH@IMFMAFDM@C?3?2Users?2nsika?2Downloads?2Invent@ ; `string'
PUBLIC	??_C@_0BC@LJMJJIKJ@?5items?5in?5stock?4?5@	; `string'
PUBLIC	??_C@_05KAHKAFCL@?5has?5@			; `string'
PUBLIC	??_C@_0N@IIBEEFKN@Item?5number?5@		; `string'
...
CONST	ENDS
;	COMDAT ??_C@_0N@IIBEEFKN@Item?5number?5@
CONST	SEGMENT
??_C@_0N@IIBEEFKN@Item?5number?5@ DB 'Item number ', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_05KAHKAFCL@?5has?5@
CONST	SEGMENT
??_C@_05KAHKAFCL@?5has?5@ DB ' has ', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_0BC@LJMJJIKJ@?5items?5in?5stock?4?5@
CONST	SEGMENT
??_C@_0BC@LJMJJIKJ@?5items?5in?5stock?4?5@ DB ' items in stock. ', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0CH@IMFMAFDM@C?3?2Users?2nsika?2Downloads?2Invent@
CONST	SEGMENT
??_C@_0CH@IMFMAFDM@C?3?2Users?2nsika?2Downloads?2Invent@ DB 'C:\Users\nsi'
	DB	'ka\Downloads\Inventory.dat', 00H		; `string'
CONST	ENDS
...
; 47   : {
	...
	lea	eax, DWORD PTR __$EHRec$[ebp]
	mov	DWORD PTR fs:0, eax
	mov	ecx, OFFSET __EA320253_Ch13lab4@cpp
	call	@__CheckForDebuggerJustMyCode@4

; 48   : 
; 49   :     ifstream infile;	      // Input file to read values into array
...
; 50   :     infile.open("C:\\Users\\nsika\\Downloads\\Inventory.dat");

	push	64					; 00000040H
	push	1
	push	OFFSET ??_C@_0CH@IMFMAFDM@C?3?2Users?2nsika?2Downloads?2Invent@
	lea	ecx, DWORD PTR _infile$[ebp]
	call	?open@?$basic_ifstream@DU?$char_traits@D@std@@@std@@QAEXPBDHH@Z ; std::basic_ifstream<char,std::char_traits<char> >::open

; 51   : 
; 52   :     // Fill in the code that declares an array of objects of class Inventory
; 53   :     // called products. The array should be of size NUMOFPROD
; 54   :     Inventory products[NUMOFPROD];
; 55   : 
; 56   :     int pos;                   // loop counter
; 57   :     int id;                    // variable holding the id number
; 58   :     int total;                 // variable holding the total for each id number
; 59   : 
; 60   :     // Fill in the code that will read inventory numbers and number of items  
; 61   :     // from a file into the array of objects. There should be calls to both  
; 62   :     // getId and getAmount member functions somewhere in this code.
; 63   :     // Example: products[pos].getId(id); will be somewhere in this code
; 64   :     if (infile)
...
; 65   :     {
; 66   :         for (pos = 0; pos < NUMOFPROD; pos++)
...
; 69   :             products[pos].getId(id);

	mov	eax, DWORD PTR _id$[ebp]
	push	eax
	mov	ecx, DWORD PTR _pos$[ebp]
	lea	ecx, DWORD PTR _products$[ebp+ecx*8]
	call	?getId@Inventory@@QAEXH@Z		; Inventory::getId

; 70   :             products[pos].getAmount(total);

	mov	eax, DWORD PTR _total$[ebp]
	push	eax
	mov	ecx, DWORD PTR _pos$[ebp]
	lea	ecx, DWORD PTR _products$[ebp+ecx*8]
	call	?getAmount@Inventory@@QAEXH@Z		; Inventory::getAmount

; 71   :             products[pos].display();

	mov	eax, DWORD PTR _pos$[ebp]
	lea	ecx, DWORD PTR _products$[ebp+eax*8]
	call	?display@Inventory@@QAEXXZ		; Inventory::display
...
; 73   :     }
; 74   : 
; 75   :     // Fill in the code to print out the values (itemNumber and numOfItem) for 
; 76   :     // each object in the array products.
; 77   :     // This should be done by calling the member function display within a loop
; 78   : 
; 79   :     return 0;
...
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch13lab4.cpp
;	COMDAT ?display@Inventory@@QAEXXZ
_TEXT	SEGMENT
_this$ = -8						; size = 4
?display@Inventory@@QAEXXZ PROC				; Inventory::display, COMDAT
; _this$ = ecx
...
; 97   :     cout << "Item number " << itemNumber << " has " << numOfItem << " items in stock. " << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0BC@LJMJJIKJ@?5items?5in?5stock?4?5@
	mov	edi, esp
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+4]
	push	ecx
	push	OFFSET ??_C@_05KAHKAFCL@?5has?5@
	mov	ebx, esp
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx]
	push	eax
	push	OFFSET ??_C@_0N@IIBEEFKN@Item?5number?5@
...
; 98   : }
	...
	pop	ebp
	ret	0
?display@Inventory@@QAEXXZ ENDP				; Inventory::display
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch13lab4.cpp
;	COMDAT ?getAmount@Inventory@@QAEXH@Z
_TEXT	SEGMENT
_this$ = -8						; size = 4
_amounts$ = 8						; size = 4
?getAmount@Inventory@@QAEXH@Z PROC			; Inventory::getAmount, COMDAT
; _this$ = ecx
...
; 92   :     numOfItem = amounts;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _amounts$[ebp]
	mov	DWORD PTR [eax+4], ecx
...
; 93   : }
	...
	pop	ebp
	ret	4
?getAmount@Inventory@@QAEXH@Z ENDP			; Inventory::getAmount
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch13lab4.cpp
;	COMDAT ?getId@Inventory@@QAEXH@Z
_TEXT	SEGMENT
_this$ = -8						; size = 4
_idd$ = 8						; size = 4
?getId@Inventory@@QAEXH@Z PROC				; Inventory::getId, COMDAT
; _this$ = ecx
...
; 88   : }
	...
	pop	ebp
	ret	4
?getId@Inventory@@QAEXH@Z ENDP				; Inventory::getId
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\VC\Tools\MSVC\14.28.29333\include\fstream
