; Listing generated by Microsoft (R) Optimizing Compiler Version 19.28.29336.0 
	...
	TITLE	C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch10Lab5Option3.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__B862E349_Ch10Lab5Option3@cpp DB 01H
...
PUBLIC	??_C@_0DF@JCBJOJGB@Please?5input?5a?5string?5of?5no?5mor@ ; `string'
PUBLIC	??_C@_0BG@EJEJNHDB@The?5input?5string?5is?3?5@	; `string'
PUBLIC	??_C@_0BN@KANFIEJ@The?5number?5of?5consonants?5is?5@ ; `string'
EXTRN	_strlen:PROC
...
rtc$IMZ	ENDS
;	COMDAT ??_C@_0BN@KANFIEJ@The?5number?5of?5consonants?5is?5@
CONST	SEGMENT
??_C@_0BN@KANFIEJ@The?5number?5of?5consonants?5is?5@ DB 'The number of co'
	DB	'nsonants is ', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0BG@EJEJNHDB@The?5input?5string?5is?3?5@
CONST	SEGMENT
??_C@_0BG@EJEJNHDB@The?5input?5string?5is?3?5@ DB 'The input string is: ', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0DF@JCBJOJGB@Please?5input?5a?5string?5of?5no?5mor@
CONST	SEGMENT
??_C@_0DF@JCBJOJGB@Please?5input?5a?5string?5of?5no?5mor@ DB 'Please inpu'
	DB	't a string of no more than 50 characters:', 00H ; `string'
CONST	ENDS
;	COMDAT xdata$x
xdata$x	SEGMENT
...
; 7    : {
	...
	xor	eax, ebp
	mov	DWORD PTR __$ArrayPad$[ebp], eax
	mov	ecx, OFFSET __B862E349_Ch10Lab5Option3@cpp
	call	@__CheckForDebuggerJustMyCode@4

; 8    : 	char string1[STRINGTEXT];
; 9    : 
; 10   : 	cout << "Please input a string of no more than 50 characters:" << endl << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	mov	edi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0DF@JCBJOJGB@Please?5input?5a?5string?5of?5no?5mor@
...
; 11   : 	cin.getline(string1, STRINGTEXT);
...
; 12   : 
; 13   : 	cout << "The input string is: " << endl ;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0BG@EJEJNHDB@The?5input?5string?5is?3?5@
	mov	eax, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	eax
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
...
; 24   : 
; 25   : 		if (toupper(string1[count]) != 'A' && toupper(string1[count]) != 'E' && toupper(string1[count]) != 'I' && toupper(string1[count]) != 'O' && toupper(string1[count]) != 'U')
...
; 31   : 
; 32   : 	cout << endl << "The number of consonants is " << amount << endl;
	...
	mov	eax, DWORD PTR _amount$[ebp]
	push	eax
	push	OFFSET ??_C@_0BN@KANFIEJ@The?5number?5of?5consonants?5is?5@
	mov	ebx, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	mov	ecx, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	call	DWORD PTR __imp_??6?$basic_ostream@DU?$char_traits@D@std@@@std@@QAEAAV01@P6AAAV01@AAV01@@Z@Z
