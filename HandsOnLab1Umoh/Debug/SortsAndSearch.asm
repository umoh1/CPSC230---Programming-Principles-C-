; Listing generated by Microsoft (R) Optimizing Compiler Version 19.28.29336.0 
	...
	TITLE	C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\SortsAndSearch.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__AD5BBA6B_SortsAndSearch@cpp DB 01H
...
PUBLIC	?linearSearch@@YAHQAHHH@Z			; linearSearch
...
PUBLIC	??_C@_0O@FGOOMBKO@?5is?5at?5index?5@		; `string'
PUBLIC	??_C@_08CLAEPLAI@Element?5@			; `string'
PUBLIC	??_C@_0BD@IHCFCNGM@Element?5not?5found?4@	; `string'
...
CONST	ENDS
;	COMDAT ??_C@_0BD@IHCFCNGM@Element?5not?5found?4@
CONST	SEGMENT
??_C@_0BD@IHCFCNGM@Element?5not?5found?4@ DB 'Element not found.', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_08CLAEPLAI@Element?5@
CONST	SEGMENT
??_C@_08CLAEPLAI@Element?5@ DB 'Element ', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_0O@FGOOMBKO@?5is?5at?5index?5@
CONST	SEGMENT
??_C@_0O@FGOOMBKO@?5is?5at?5index?5@ DB ' is at index ', 00H ; `string'
CONST	ENDS
;	COMDAT xdata$x
xdata$x	SEGMENT
...
; 11   : {
	...
	xor	eax, ebp
	mov	DWORD PTR __$ArrayPad$[ebp], eax
	mov	ecx, OFFSET __AD5BBA6B_SortsAndSearch@cpp
	call	@__CheckForDebuggerJustMyCode@4

; 12   : 	int search[9] = { 9,8,7,6,1,2,3,4,5 };

	mov	DWORD PTR _search$[ebp], 9
	mov	DWORD PTR _search$[ebp+4], 8
	mov	DWORD PTR _search$[ebp+8], 7
	mov	DWORD PTR _search$[ebp+12], 6
	mov	DWORD PTR _search$[ebp+16], 1
	mov	DWORD PTR _search$[ebp+20], 2
	mov	DWORD PTR _search$[ebp+24], 3
	mov	DWORD PTR _search$[ebp+28], 4
	mov	DWORD PTR _search$[ebp+32], 5

; 13   : 
; 14   : 	int var = 2;

	mov	DWORD PTR _var$[ebp], 2

; 15   : 	int index = binarySearch(search, var, 9);
...
; 17   : 	{
; 18   : 		cout <<endl<< "Element " << var << " is at index " << index << endl;
	...
	push	eax
	push	OFFSET ??_C@_0O@FGOOMBKO@?5is?5at?5index?5@
	mov	ebx, esp
	mov	ecx, DWORD PTR _var$[ebp]
	push	ecx
	push	OFFSET ??_C@_08CLAEPLAI@Element?5@
	mov	eax, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
...
; 22   : 		cout << "Element not found." << endl;
	...
	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0BD@IHCFCNGM@Element?5not?5found?4@
...
; 29   : 	int sort1;
; 30   : 	//outer loop, goes through each element and makes sure that it is put in the right place
; 31   : 	for(int i = 0; i<size1-1; i++)
...
$LN4@bubbleSort:
	...
	jge	SHORT $LN3@bubbleSort

; 32   : 		for (int j = 0; j <size1-i-1 ; j++)
...
$LN10@bubbleSort:
	mov	eax, DWORD PTR _i$1[ebp]
	cmp	eax, DWORD PTR _size1$[ebp]
	jge	SHORT $LN1@bubbleSort
...
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\SortsAndSearch.cpp
;	COMDAT ?linearSearch@@YAHQAHHH@Z
_TEXT	SEGMENT
_i$1 = -8						; size = 4
_array1$ = 8						; size = 4
_search$ = 12						; size = 4
_size1$ = 16						; size = 4
?linearSearch@@YAHQAHHH@Z PROC				; linearSearch, COMDAT
...
; 95   : }
	...
	pop	ebp
	ret	0
?linearSearch@@YAHQAHHH@Z ENDP				; linearSearch
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\SortsAndSearch.cpp
...
; 63   : 		int middle = (last-first)/ 2;
	...
	sub	eax, edx
	sar	eax, 1
	mov	DWORD PTR _middle$1[ebp], eax

; 64   : 
; 65   : 		if (array1[middle] == search)

	mov	eax, DWORD PTR _middle$1[ebp]
	mov	ecx, DWORD PTR _array1$[ebp]
	mov	edx, DWORD PTR [ecx+eax*4]
	cmp	edx, DWORD PTR _search$[ebp]
...
; 69   : 		else if (search>array1[middle])
