; Listing generated by Microsoft (R) Optimizing Compiler Version 19.28.29336.0 
	...
	TITLE	C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch9lab4search.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__E4363F5D_Ch9lab4search@cpp DB 01H
...
PUBLIC	?linearSearch@@YA_NQAHHH@Z			; linearSearch
PUBLIC	_main
...
PUBLIC	??_C@_0DB@GFIEEGGP@Please?5input?5the?5number?5of?5ID?5n@ ; `string'
PUBLIC	??_C@_0BK@FLMKOFIN@Please?5enter?5an?5ID?5number@ ; `string'
PUBLIC	??_C@_0CL@JHFEOJED@Please?5input?5an?5ID?5number?5to?5be@ ; `string'
PUBLIC	??_C@_0BB@JBJOGCGJ@?5is?5in?5the?5array@	; `string'
PUBLIC	??_C@_0BF@LCJAKFN@?5is?5not?5in?5the?5array@	; `string'
...
rtc$IMZ	ENDS
;	COMDAT ??_C@_0BF@LCJAKFN@?5is?5not?5in?5the?5array@
CONST	SEGMENT
??_C@_0BF@LCJAKFN@?5is?5not?5in?5the?5array@ DB ' is not in the array', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BB@JBJOGCGJ@?5is?5in?5the?5array@
CONST	SEGMENT
??_C@_0BB@JBJOGCGJ@?5is?5in?5the?5array@ DB ' is in the array', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0CL@JHFEOJED@Please?5input?5an?5ID?5number?5to?5be@
CONST	SEGMENT
??_C@_0CL@JHFEOJED@Please?5input?5an?5ID?5number?5to?5be@ DB 'Please inpu'
	DB	't an ID number to be searched: ', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0BK@FLMKOFIN@Please?5enter?5an?5ID?5number@
CONST	SEGMENT
??_C@_0BK@FLMKOFIN@Please?5enter?5an?5ID?5number@ DB 'Please enter an ID '
	DB	'number', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0DB@GFIEEGGP@Please?5input?5the?5number?5of?5ID?5n@
CONST	SEGMENT
??_C@_0DB@GFIEEGGP@Please?5input?5the?5number?5of?5ID?5n@ DB 'Please inpu'
	DB	't the number of ID numbers to be read', 00H	; `string'
CONST	ENDS
;	COMDAT xdata$x
xdata$x	SEGMENT
...
; 7    : {	
	...
	xor	eax, ebp
	mov	DWORD PTR __$ArrayPad$[ebp], eax
	mov	ecx, OFFSET __E4363F5D_Ch9lab4search@cpp
	call	@__CheckForDebuggerJustMyCode@4

; 8    : 	int* ids;
; 9    : 	int number;
; 10   : 
; 11   : 	cout << "Please input the number of ID numbers to be read" << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0DB@GFIEEGGP@Please?5input?5the?5number?5of?5ID?5n@
...
; 17   : 	{
; 18   : 		cout << "Please enter an ID number" << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0BK@FLMKOFIN@Please?5enter?5an?5ID?5number@
	mov	eax, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	eax
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
...
; 21   : 
; 22   : 	int search; 
; 23   : 	cout << "Please input an ID number to be searched: " << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0CL@JHFEOJED@Please?5input?5an?5ID?5number?5to?5be@
	mov	eax, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	eax
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
...
; 25   : 
; 26   : 	if (linearSearch(ids, number, search))
	...
	push	edx
	call	?linearSearch@@YA_NQAHHH@Z		; linearSearch
...
; 27   : 	{
; 28   : 		cout << search << " is in the array" << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0BB@JBJOGCGJ@?5is?5in?5the?5array@
	mov	edi, esp
	mov	eax, DWORD PTR _search$[ebp]
	push	eax
...
; 30   : 	else
; 31   : 	{
; 32   : 		cout << search << " is not in the array" << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0BF@LCJAKFN@?5is?5not?5in?5the?5array@
	mov	edi, esp
	mov	eax, DWORD PTR _search$[ebp]
	push	eax
	mov	ecx, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
...
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch9lab4search.cpp
;	COMDAT ?linearSearch@@YA_NQAHHH@Z
_TEXT	SEGMENT
_i$1 = -8						; size = 4
_arrayW$ = 8						; size = 4
_number$ = 12						; size = 4
_searching$ = 16					; size = 4
?linearSearch@@YA_NQAHHH@Z PROC				; linearSearch, COMDAT
...
$LN4@linearSear:
	mov	eax, DWORD PTR _i$1[ebp]
	cmp	eax, DWORD PTR _number$[ebp]
	jge	SHORT $LN3@linearSear

; 39   : 	{
; 40   : 		if (searching==arrayW[i])

	mov	eax, DWORD PTR _i$1[ebp]
	mov	ecx, DWORD PTR _arrayW$[ebp]
	mov	edx, DWORD PTR _searching$[ebp]
	cmp	edx, DWORD PTR [ecx+eax*4]
	jne	SHORT $LN5@linearSear

; 41   : 		{
; 42   : 			return true;

	mov	al, 1
	jmp	SHORT $LN1@linearSear
$LN5@linearSear:

; 43   : 		}
; 44   : 	}

	jmp	SHORT $LN2@linearSear
$LN3@linearSear:
...
; 47   : }
	...
	pop	ebp
	ret	0
?linearSearch@@YA_NQAHHH@Z ENDP				; linearSearch
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
