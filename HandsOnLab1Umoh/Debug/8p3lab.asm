; Listing generated by Microsoft (R) Optimizing Compiler Version 19.28.29336.0 
	...
	TITLE	C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\8p3lab.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?bubbleSortArray@@YAXQAHH@Z			; bubbleSortArray
...
PUBLIC	??_C@_0DE@BPBGADDI@The?5values?5before?5the?5bubble?5so@ ; `string'
PUBLIC	??_C@_0DD@OJLDLBHD@The?5values?5after?5the?5bubble?5sor@ ; `string'
PUBLIC	??_C@_02KNHHEEKP@?5?5@				; `string'
PUBLIC	??_C@_0BM@EKCOJHFC@?5Step?5in?5sorting?5the?5array?4@ ; `string'
PUBLIC	??_C@_04NBEEJDGM@The?5@				; `string'
EXTRN	_strlen:PROC
...
rtc$IMZ	ENDS
;	COMDAT ??_C@_04NBEEJDGM@The?5@
CONST	SEGMENT
??_C@_04NBEEJDGM@The?5@ DB 'The ', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0BM@EKCOJHFC@?5Step?5in?5sorting?5the?5array?4@
CONST	SEGMENT
??_C@_0BM@EKCOJHFC@?5Step?5in?5sorting?5the?5array?4@ DB ' Step in sortin'
	DB	'g the array.', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_02KNHHEEKP@?5?5@
CONST	SEGMENT
??_C@_02KNHHEEKP@?5?5@ DB '  ', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0DD@OJLDLBHD@The?5values?5after?5the?5bubble?5sor@
CONST	SEGMENT
??_C@_0DD@OJLDLBHD@The?5values?5after?5the?5bubble?5sor@ DB 'The values a'
	DB	'fter the bubble sort is performed are:', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0DE@BPBGADDI@The?5values?5before?5the?5bubble?5so@
CONST	SEGMENT
??_C@_0DE@BPBGADDI@The?5values?5before?5the?5bubble?5so@ DB 'The values b'
	DB	'efore the bubble sort is performed are:', 00H ; `string'
CONST	ENDS
;	COMDAT xdata$x
xdata$x	SEGMENT
...
; 17   : {
	...
	xor	eax, ebp
	mov	DWORD PTR __$ArrayPad$[ebp], eax
	mov	ecx, OFFSET __90C774E1_8p3lab@cpp
	call	@__CheckForDebuggerJustMyCode@4

; 18   : 	int values[SIZE] = { 23 ,0 , 45 ,-3,-78, 1 ,-1, 9 };

	mov	DWORD PTR _values$[ebp], 23		; 00000017H
	mov	DWORD PTR _values$[ebp+4], 0
	mov	DWORD PTR _values$[ebp+8], 45		; 0000002dH
	mov	DWORD PTR _values$[ebp+12], -3		; fffffffdH
	mov	DWORD PTR _values$[ebp+16], -78		; ffffffb2H
	mov	DWORD PTR _values$[ebp+20], 1
	mov	DWORD PTR _values$[ebp+24], -1
	mov	DWORD PTR _values$[ebp+28], 9

; 19   : 
; 20   : 	cout << "The values before the bubble sort is performed are:" << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0DE@BPBGADDI@The?5values?5before?5the?5bubble?5so@
...
; 22   : 
; 23   : 	bubbleSortArray(values, SIZE);

	push	8
	lea	eax, DWORD PTR _values$[ebp]
	push	eax
	call	?bubbleSortArray@@YAXQAHH@Z		; bubbleSortArray
	add	esp, 8

; 24   : 
; 25   : 	cout << "The values after the bubble sort is performed are:" << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0DD@OJLDLBHD@The?5values?5after?5the?5bubble?5sor@
	mov	eax, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	eax
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
...
; 41   : 	for (int count = 0; count < elems; count++)
...
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\8p3lab.cpp
;	COMDAT ?bubbleSortArray@@YAXQAHH@Z
_TEXT	SEGMENT
tv91 = -256						; size = 4
_count$1 = -56						; size = 4
_bottom$ = -44						; size = 4
...
_array$ = 8						; size = 4
_elems$ = 12						; size = 4
?bubbleSortArray@@YAXQAHH@Z PROC			; bubbleSortArray, COMDAT
...
; 63   : 
; 64   : 	int bottom = elems - 1;     // bottom indicates the end part of the 
...
; 65   : 								// array where the largest values have
; 66   : 								// settled in order
; 67   : 	do
; 68   : 	{
; 69   : 		swap = false;
...
; 70   : 		for (int count = 0; count < bottom; count++)
...
; 71   : 		{
; 72   : 			
; 73   : 			//If the current element is less than the next element, swap
; 74   : 			if (array[count] < array[count + 1])
...
; 75   : 			{	          // the next three lines do a swap   
; 76   : 				temp = array[count];
...
; 79   : 				swap = true; // indicates that a swap occurred

	mov	BYTE PTR _swap$[ebp], 1

; 80   : 
; 81   : 				cout << "The " << num++ << " Step in sorting the array." << endl;
	...
	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0BM@EKCOJHFC@?5Step?5in?5sorting?5the?5array?4@
	mov	edi, esp
	mov	edx, DWORD PTR tv91[ebp]
	push	edx
	push	OFFSET ??_C@_04NBEEJDGM@The?5@
	mov	eax, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	eax
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
...
; 86   : 		bottom--;     // bottom is decremented by 1 since each pass through

	mov	eax, DWORD PTR _bottom$[ebp]
	sub	eax, 1
	mov	DWORD PTR _bottom$[ebp], eax

; 87   : 					// the array adds one more value that is set in order
; 88   : 
; 89   : 	} while (swap != false);
...
; 90   : 	// loop repeats until a pass through the array with
; 91   :   // no swaps occurs
; 92   : }
	...
	pop	ebp
	ret	0
?bubbleSortArray@@YAXQAHH@Z ENDP			; bubbleSortArray
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
