; Listing generated by Microsoft (R) Optimizing Compiler Version 19.28.29336.0 
	...
	TITLE	C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch9Lab1.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??_C@_0CJ@OLAIIJPD@Please?5input?5the?5length?5of?5the?5@ ; `string'
PUBLIC	??_C@_0CI@JODDNOOF@Please?5input?5the?5width?5of?5the?5r@ ; `string'
PUBLIC	??_C@_0N@ICKPBOFH@The?5area?5is?5@		; `string'
PUBLIC	??_C@_0CF@ICPAEAAA@The?5length?5is?5greater?5than?5the?5@ ; `string'
PUBLIC	??_C@_0CF@MFGDFKNI@The?5width?5is?5greater?5than?5the?5l@ ; `string'
PUBLIC	??_C@_0CC@BEDNDDPI@The?5width?5and?5length?5are?5the?5sa@ ; `string'
EXTRN	_strlen:PROC
...
rtc$IMZ	ENDS
;	COMDAT ??_C@_0CC@BEDNDDPI@The?5width?5and?5length?5are?5the?5sa@
CONST	SEGMENT
??_C@_0CC@BEDNDDPI@The?5width?5and?5length?5are?5the?5sa@ DB 'The width a'
	DB	'nd length are the same', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_0CF@MFGDFKNI@The?5width?5is?5greater?5than?5the?5l@
CONST	SEGMENT
??_C@_0CF@MFGDFKNI@The?5width?5is?5greater?5than?5the?5l@ DB 'The width i'
	DB	's greater than the length', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_0CF@ICPAEAAA@The?5length?5is?5greater?5than?5the?5@
CONST	SEGMENT
??_C@_0CF@ICPAEAAA@The?5length?5is?5greater?5than?5the?5@ DB 'The length '
	DB	'is greater than the width', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_0N@ICKPBOFH@The?5area?5is?5@
CONST	SEGMENT
??_C@_0N@ICKPBOFH@The?5area?5is?5@ DB 'The area is ', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0CI@JODDNOOF@Please?5input?5the?5width?5of?5the?5r@
CONST	SEGMENT
??_C@_0CI@JODDNOOF@Please?5input?5the?5width?5of?5the?5r@ DB 'Please inpu'
	DB	't the width of the rectangle', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_0CJ@OLAIIJPD@Please?5input?5the?5length?5of?5the?5@
CONST	SEGMENT
??_C@_0CJ@OLAIIJPD@Please?5input?5the?5length?5of?5the?5@ DB 'Please inpu'
	DB	't the length of the rectangle', 00H		; `string'
CONST	ENDS
;	COMDAT xdata$x
xdata$x	SEGMENT
...
; 5    : {
	...
	xor	eax, ebp
	mov	DWORD PTR __$ArrayPad$[ebp], eax
	mov	ecx, OFFSET __9714055F_Ch9Lab1@cpp
	call	@__CheckForDebuggerJustMyCode@4

; 6    : 
; 7    :     int length;		// holds length
; 8    :     int width;		// holds width
; 9    :     int area;		// holds area
; 10   : 
; 11   :     int* lengthPtr;	// int pointer which will be set to point to length
; 12   :     int* widthPtr;   // int pointer which will be set to point to width
; 13   : 
; 14   :     cout << "Please input the length of the rectangle" << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0CJ@OLAIIJPD@Please?5input?5the?5length?5of?5the?5@
...
; 16   :     cout << "Please input the width of the rectangle" << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0CI@JODDNOOF@Please?5input?5the?5width?5of?5the?5r@
	mov	eax, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	eax
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
...
; 18   : 
; 19   :     // Fill in code to make lengthPtr point to length (hold its address)
; 20   :     lengthPtr = &length;

	lea	eax, DWORD PTR _length$[ebp]
	mov	DWORD PTR _lengthPtr$[ebp], eax

; 21   :     // Fill in code to make widthPtr point to width (hold its address) 
; 22   :     widthPtr = &width;

	lea	eax, DWORD PTR _width$[ebp]
	mov	DWORD PTR _widthPtr$[ebp], eax

; 23   : 
; 24   :         // Fill in code to find the area by using only the pointer variables
; 25   :     area = *lengthPtr * *widthPtr;

	mov	eax, DWORD PTR _lengthPtr$[ebp]
	mov	ecx, DWORD PTR _widthPtr$[ebp]
	mov	edx, DWORD PTR [eax]
	imul	edx, DWORD PTR [ecx]
	mov	DWORD PTR _area$[ebp], edx

; 26   :     cout << "The area is " << area << endl;
	...
	push	eax
	push	OFFSET ??_C@_0N@ICKPBOFH@The?5area?5is?5@
...
; 28   : 
; 29   : 
; 30   :     if (*lengthPtr>*widthPtr)// Fill in the condition of length > width by using only the pointer variables)
...
; 31   :         cout << "The length is greater than the width" << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0CF@ICPAEAAA@The?5length?5is?5greater?5than?5the?5@
	mov	eax, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	eax
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
...
; 32   : 
; 33   :     else if (*widthPtr>*lengthPtr)

	mov	eax, DWORD PTR _widthPtr$[ebp]
	mov	ecx, DWORD PTR _lengthPtr$[ebp]
	mov	edx, DWORD PTR [eax]
	cmp	edx, DWORD PTR [ecx]
	jle	SHORT $LN4@main

; 34   :         // Fill in the condition of width > length by using only the pointer 
; 35   :              // variables)
; 36   :         cout << "The width is greater than the length" << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0CF@MFGDFKNI@The?5width?5is?5greater?5than?5the?5l@
	mov	eax, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	eax
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
...
; 37   : 
; 38   :     else
; 39   :         cout << "The width and length are the same" << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0CC@BEDNDDPI@The?5width?5and?5length?5are?5the?5sa@
	mov	eax, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	eax
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
