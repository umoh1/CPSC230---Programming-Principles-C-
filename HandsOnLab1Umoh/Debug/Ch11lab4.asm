; Listing generated by Microsoft (R) Optimizing Compiler Version 19.28.29336.0 
	...
	TITLE	C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch11lab4.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__C4C42AD5_Ch11lab4@cpp DB 01H
...
PUBLIC	?calculateArea@@YAMUrectangle@@@Z		; calculateArea
PUBLIC	?calculatePerimeter@@YAMUrectangle@@@Z		; calculatePerimeter
PUBLIC	_main
...
PUBLIC	??_C@_0CD@EFEEPLGG@The?5perimeter?5of?5the?5rectangle?5@ ; `string'
...
CONST	ENDS
;	COMDAT ??_C@_0CD@EFEEPLGG@The?5perimeter?5of?5the?5rectangle?5@
CONST	SEGMENT
??_C@_0CD@EFEEPLGG@The?5perimeter?5of?5the?5rectangle?5@ DB 'The perimete'
	DB	'r of the rectangle is ', 00H		; `string'
CONST	ENDS
...
; 38   : {
	...
	xor	eax, ebp
	mov	DWORD PTR __$ArrayPad$[ebp], eax
	mov	ecx, OFFSET __C4C42AD5_Ch11lab4@cpp
	call	@__CheckForDebuggerJustMyCode@4

; 39   : 	// Fill in code to declare a rectangle structure variable named box.
; 40   : 	rectangle box;
; 41   : 
; 42   : 	cout << "Enter the length of a rectangle: ";
...
; 44   : 
; 45   : 	// Fill in code to read in the length to the appropriate location
; 46   : 
; 47   : 	cout << "Enter the width of a rectangle: ";
...
; 48   : 	cin >> box.sizes.width;

	mov	esi, esp
	lea	eax, DWORD PTR _box$[ebp+12]
	push	eax
	mov	ecx, DWORD PTR __imp_?cin@std@@3V?$basic_istream@DU?$char_traits@D@std@@@1@A
	call	DWORD PTR __imp_??5?$basic_istream@DU?$char_traits@D@std@@@std@@QAEAAV01@AAM@Z
	cmp	esi, esp
...
; 49   : 
; 50   : 	// Fill in code to read in the width to the appropriate location 
; 51   : 
; 52   : 	cout << endl << endl;
...
; 53   : 
; 54   : 	// Fill in code to compute the area and store it in the appropriate
; 55   : 	// location
; 56   : 	// Fill in code to compute the perimeter and store it in the 
; 57   : 	// appropriate location
; 58   : 
; 59   : 	//box.attributes.area = 
; 60   : 	//box.attributes.perimeter = ;
; 61   : 
...
; 63   : 	cout << "The area of the rectangle is " << calculateArea(box) << endl;
	...
	mov	ecx, DWORD PTR _box$[ebp+8]
	mov	DWORD PTR [eax+8], ecx
	mov	edx, DWORD PTR _box$[ebp+12]
	mov	DWORD PTR [eax+12], edx
	call	?calculateArea@@YAMUrectangle@@@Z	; calculateArea
...
; 64   : 	cout << "The perimeter of the rectangle is " <<calculatePerimeter(box)
	...
	mov	edx, DWORD PTR _box$[ebp+12]
	mov	DWORD PTR [eax+12], edx
	call	?calculatePerimeter@@YAMUrectangle@@@Z	; calculatePerimeter
	add	esp, 16					; 00000010H
	mov	edi, esp
	push	ecx
	fstp	DWORD PTR [esp]
	push	OFFSET ??_C@_0CD@EFEEPLGG@The?5perimeter?5of?5the?5rectangle?5@
	mov	eax, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	eax
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
...
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch11lab4.cpp
;	COMDAT ?calculatePerimeter@@YAMUrectangle@@@Z
_TEXT	SEGMENT
tv71 = -196						; size = 4
_rect$ = 8						; size = 16
?calculatePerimeter@@YAMUrectangle@@@Z PROC		; calculatePerimeter, COMDAT
...
; 77   : 	return (2 * rect.sizes.length) + (2 * rect.sizes.width);

	movss	xmm0, DWORD PTR __real@40000000
	mulss	xmm0, DWORD PTR _rect$[ebp+8]
	movss	xmm1, DWORD PTR __real@40000000
	mulss	xmm1, DWORD PTR _rect$[ebp+12]
	addss	xmm0, xmm1
...
; 78   : }
	...
	pop	ebp
	ret	0
?calculatePerimeter@@YAMUrectangle@@@Z ENDP		; calculatePerimeter
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch11lab4.cpp
;	COMDAT ?calculateArea@@YAMUrectangle@@@Z
_TEXT	SEGMENT
tv68 = -196						; size = 4
_rect$ = 8						; size = 16
?calculateArea@@YAMUrectangle@@@Z PROC			; calculateArea, COMDAT
...
; 72   : 	return rect.sizes.length * rect.sizes.width;

	movss	xmm0, DWORD PTR _rect$[ebp+8]
	mulss	xmm0, DWORD PTR _rect$[ebp+12]
...
; 73   : }
	...
	pop	ebp
	ret	0
?calculateArea@@YAMUrectangle@@@Z ENDP			; calculateArea
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
