; Listing generated by Microsoft (R) Optimizing Compiler Version 19.28.29336.0 
	...
	TITLE	C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\8p2lab.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??_C@_0CA@HIDNLCGI@Enter?5an?5integer?5to?5search?5for?3@ ; `string'
PUBLIC	??_C@_0BE@JCPDCNFL@?5is?5not?5in?5the?5list@	; `string'
PUBLIC	??_C@_0L@OGAGNMOJ@The?5value?5@			; `string'
PUBLIC	??_C@_0N@JJGEFJMH@?5of?5the?5list@		; `string'
PUBLIC	??_C@_0BI@ELMELHDH@?5is?5in?5position?5number?5@ ; `string'
EXTRN	_strlen:PROC
...
rtc$IMZ	ENDS
;	COMDAT ??_C@_0BI@ELMELHDH@?5is?5in?5position?5number?5@
CONST	SEGMENT
??_C@_0BI@ELMELHDH@?5is?5in?5position?5number?5@ DB ' is in position numb'
	DB	'er ', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0N@JJGEFJMH@?5of?5the?5list@
CONST	SEGMENT
??_C@_0N@JJGEFJMH@?5of?5the?5list@ DB ' of the list', 00H ; `string'
CONST	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_0CA@HIDNLCGI@Enter?5an?5integer?5to?5search?5for?3@
CONST	SEGMENT
??_C@_0CA@HIDNLCGI@Enter?5an?5integer?5to?5search?5for?3@ DB 'Enter an in'
...
; 13   : {
	...
	xor	eax, ebp
	mov	DWORD PTR __$ArrayPad$[ebp], eax
	mov	ecx, OFFSET __5C6D747F_8p2lab@cpp
	call	@__CheckForDebuggerJustMyCode@4

; 14   : 	int found, value;
; 15   : 	int array[] = {0,2,2,3,5,9,11,12,12,12,13,17,18,19,19,34};

	mov	DWORD PTR _array$[ebp], 0
	mov	DWORD PTR _array$[ebp+4], 2
	mov	DWORD PTR _array$[ebp+8], 2
	mov	DWORD PTR _array$[ebp+12], 3
	mov	DWORD PTR _array$[ebp+16], 5
	mov	DWORD PTR _array$[ebp+20], 9
	mov	DWORD PTR _array$[ebp+24], 11		; 0000000bH
	mov	DWORD PTR _array$[ebp+28], 12		; 0000000cH
	mov	DWORD PTR _array$[ebp+32], 12		; 0000000cH
	mov	DWORD PTR _array$[ebp+36], 12		; 0000000cH
	mov	DWORD PTR _array$[ebp+40], 13		; 0000000dH
	mov	DWORD PTR _array$[ebp+44], 17		; 00000011H
	mov	DWORD PTR _array$[ebp+48], 18		; 00000012H
	mov	DWORD PTR _array$[ebp+52], 19		; 00000013H
	mov	DWORD PTR _array$[ebp+56], 19		; 00000013H
	mov	DWORD PTR _array$[ebp+60], 34		; 00000022H

; 16   : 
; 17   : 	// array to be searched
; 18   : 
; 19   : 	cout << "Enter an integer to search for:" << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0CA@HIDNLCGI@Enter?5an?5integer?5to?5search?5for?3@
...
; 21   : 
; 22   : 	found = binarySearch(array, SIZE, value);
...
; 23   : 	//function call to perform the binary search
; 24   :  //on array looking for an occurrence of value
; 25   : 	if (found == -1)

	cmp	DWORD PTR _found$[ebp], -1
	jne	SHORT $LN2@main

; 26   : 		cout << "The value " << value << " is not in the list" << endl;
...
; 27   : 	else
; 28   : 	{
; 29   : 		cout << "The value " << value << " is in position number "

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0N@JJGEFJMH@?5of?5the?5list@
	mov	eax, DWORD PTR _found$[ebp]
	add	eax, 1
	mov	edi, esp
	push	eax
	push	OFFSET ??_C@_0BI@ELMELHDH@?5is?5in?5position?5number?5@
	mov	ebx, esp
...
; 50   : 	int first = 0;		    // First element of list

	mov	DWORD PTR _first$[ebp], 0

; 51   : 	int last = numElems - 1;	    // last element of the list
...
; 52   : 	int middle;			    // variable containing the current 
; 53   : 								   // middle value of the list
; 54   : 
; 55   : 	while (first <= last)
...
; 60   : 			return middle;	     // if value is in the middle, we are done
...
; 63   : 				first = middle + 1;	    // toss out the second remaining half of
...
; 64   : 							// the array and search the first 
; 65   : 		else
; 66   : 			last = middle - 1;     
...
; 67   : 			// toss out the first remaining half of
; 68   : 							 // the array and search the second
; 69   : 	}
...
; 70   : 
; 71   : 	return -1;			     // indicates that value is not in the array
