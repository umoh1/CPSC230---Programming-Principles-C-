; Listing generated by Microsoft (R) Optimizing Compiler Version 19.28.29336.0 
	...
	TITLE	C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\DynQueueDriver.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__D2340529_DynQueue@h DB 01H
__47435E7B_DynQueue@cpp DB 01H
__C985B577_DynQueueDriver@cpp DB 01H
...
PUBLIC	??0DynQueue@@QAE@XZ				; DynQueue::DynQueue
PUBLIC	??1DynQueue@@QAE@XZ				; DynQueue::~DynQueue
PUBLIC	?enqueue@DynQueue@@QAEXM@Z			; DynQueue::enqueue
PUBLIC	?dequeue@DynQueue@@QAEXXZ			; DynQueue::dequeue
PUBLIC	?isEmpty@DynQueue@@QAE_NXZ			; DynQueue::isEmpty
PUBLIC	?display@DynQueue@@QAEXXZ			; DynQueue::display
PUBLIC	?__autoclassinit2@DynQueue@@QAEXI@Z		; DynQueue::__autoclassinit2
...
PUBLIC	??_C@_0N@LFLNDOJL@?5is?5removed?4@		; `string'
PUBLIC	??_C@_0BP@BCBFBOLK@?5in?5the?5queue?5?$CIfront?5to?5rear?$CJ?4@ ; `string'
...
CONST	ENDS
;	COMDAT ??_C@_0BP@BCBFBOLK@?5in?5the?5queue?5?$CIfront?5to?5rear?$CJ?4@
CONST	SEGMENT
??_C@_0BP@BCBFBOLK@?5in?5the?5queue?5?$CIfront?5to?5rear?$CJ?4@ DB ' in t'
	DB	'he queue (front to rear).', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_0N@LFLNDOJL@?5is?5removed?4@
CONST	SEGMENT
??_C@_0N@LFLNDOJL@?5is?5removed?4@ DB ' is removed.', 00H ; `string'
CONST	ENDS
...
; 6    : {
	...
	lea	eax, DWORD PTR __$EHRec$[ebp]
	mov	DWORD PTR fs:0, eax
	mov	ecx, OFFSET __C985B577_DynQueueDriver@cpp
	call	@__CheckForDebuggerJustMyCode@4
...
; 7    : 	DynQueue q;
	...
	call	?__autoclassinit2@DynQueue@@QAEXI@Z
	lea	ecx, DWORD PTR _q$[ebp]
	call	??0DynQueue@@QAE@XZ			; DynQueue::DynQueue
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 8    : 	q.enqueue(0);
	...
	lea	ecx, DWORD PTR _q$[ebp]
	call	?enqueue@DynQueue@@QAEXM@Z		; DynQueue::enqueue
...
; 15   : 	q.display();
	...
	lea	ecx, DWORD PTR _q$[ebp]
	call	?display@DynQueue@@QAEXXZ		; DynQueue::display
...
; 18   : 	q.dequeue();
	...
	lea	ecx, DWORD PTR _q$[ebp]
	call	?dequeue@DynQueue@@QAEXXZ		; DynQueue::dequeue
...
; 30   : 	return 0;
	...
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _q$[ebp]
	call	??1DynQueue@@QAE@XZ			; DynQueue::~DynQueue
...
__unwindfunclet$_main$0:
	lea	ecx, DWORD PTR _q$[ebp]
	jmp	??1DynQueue@@QAE@XZ			; DynQueue::~DynQueue
	int	3
	int	3
	int	3
	int	3
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ?__autoclassinit2@DynQueue@@QAEXI@Z
_TEXT	SEGMENT
_this$ = -8						; size = 4
_classSize$ = 8						; size = 4
?__autoclassinit2@DynQueue@@QAEXI@Z PROC		; DynQueue::__autoclassinit2, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
	...
	pop	ebp
	ret	4
?__autoclassinit2@DynQueue@@QAEXI@Z ENDP		; DynQueue::__autoclassinit2
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\DynQueue.cpp
;	COMDAT ?display@DynQueue@@QAEXXZ
_TEXT	SEGMENT
_nodePtr$ = -20						; size = 4
_this$ = -8						; size = 4
?display@DynQueue@@QAEXXZ PROC				; DynQueue::display, COMDAT
; _this$ = ecx
...
; 110  : {
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __47435E7B_DynQueue@cpp
	call	@__CheckForDebuggerJustMyCode@4

; 111  : 	QueueNode* nodePtr = front;
...
; 112  : 
; 113  : 	cout << "There are " <<numItems <<" in the queue (front to rear)."<< endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0BP@BCBFBOLK@?5in?5the?5queue?5?$CIfront?5to?5rear?$CJ?4@
	mov	edi, esp
	mov	eax, DWORD PTR _this$[ebp]
...
; 120  : }
	...
	pop	ebp
	ret	0
?display@DynQueue@@QAEXXZ ENDP				; DynQueue::display
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\DynQueue.cpp
;	COMDAT ?isEmpty@DynQueue@@QAE_NXZ
_TEXT	SEGMENT
_this$ = -8						; size = 4
?isEmpty@DynQueue@@QAE_NXZ PROC				; DynQueue::isEmpty, COMDAT
; _this$ = ecx
...
; 107  : }
	...
	pop	ebp
	ret	0
?isEmpty@DynQueue@@QAE_NXZ ENDP				; DynQueue::isEmpty
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\DynQueue.cpp
;	COMDAT ?dequeue@DynQueue@@QAEXXZ
_TEXT	SEGMENT
_newFront$ = -32					; size = 4
_nodePtr$ = -20						; size = 4
_this$ = -8						; size = 4
?dequeue@DynQueue@@QAEXXZ PROC				; DynQueue::dequeue, COMDAT
; _this$ = ecx
...
; 76   : 	QueueNode* nodePtr = front;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR _nodePtr$[ebp], ecx

; 77   : 	QueueNode* newFront = nullptr;

	mov	DWORD PTR _newFront$[ebp], 0
...
; 79   : 	if (numItems == 0)
	...
	mov	eax, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [eax+8], 0
	jne	SHORT $LN2@dequeue

; 80   : 	{
; 81   : 		cout << "Queue is empty." << endl;
...
; 82   : 		return;
	...
	jmp	SHORT $LN1@dequeue
$LN2@dequeue:

; 83   : 	}
; 84   : 
; 85   : 	cout << nodePtr->value << " is removed." << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0N@LFLNDOJL@?5is?5removed?4@
	mov	edi, esp
	mov	eax, DWORD PTR _nodePtr$[ebp]
	push	ecx
	movss	xmm0, DWORD PTR [eax]
...
; 86   : 
; 87   : 	//set second node to new front
; 88   : 	newFront = front->next;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax]
	mov	edx, DWORD PTR [ecx+4]
	mov	DWORD PTR _newFront$[ebp], edx

; 89   : 
; 90   : 	//delete the front
; 91   : 	//delete front;
; 92   : 
; 93   : 	//set second node to front
; 94   : 	front = newFront;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _newFront$[ebp]
	mov	DWORD PTR [eax], ecx
...
; 97   : }
	...
	pop	ebp
	ret	0
?dequeue@DynQueue@@QAEXXZ ENDP				; DynQueue::dequeue
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\DynQueue.cpp
;	COMDAT ?enqueue@DynQueue@@QAEXM@Z
_TEXT	SEGMENT
$T1 = -236						; size = 4
_newNode$ = -32						; size = 4
_nodePtr$ = -20						; size = 4
_this$ = -8						; size = 4
_n$ = 8							; size = 4
?enqueue@DynQueue@@QAEXM@Z PROC				; DynQueue::enqueue, COMDAT
; _this$ = ecx
...
; 32   : 	QueueNode* nodePtr = nullptr;

	mov	DWORD PTR _nodePtr$[ebp], 0

; 33   : 	QueueNode* newNode = new QueueNode;
...
; 37   : 
; 38   : 	//If there are no nodes, set the front and rear = to the new node
; 39   : 	if (!front)

	mov	eax, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [eax], 0
	jne	SHORT $LN4@enqueue
...
; 58   : 
; 59   : 			while (nodePtr->next)

	mov	eax, DWORD PTR _nodePtr$[ebp]
	cmp	DWORD PTR [eax+4], 0
	je	SHORT $LN3@enqueue
...
; 62   : 			}
	...
	jmp	SHORT $LN2@enqueue
$LN3@enqueue:

; 63   : 
; 64   : 			//append new node and set rear
; 65   : 			nodePtr->next = newNode;
...
; 72   : }
	...
	pop	ebp
	ret	4
?enqueue@DynQueue@@QAEXM@Z ENDP				; DynQueue::enqueue
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\DynQueue.cpp
;	COMDAT ??1DynQueue@@QAE@XZ
_TEXT	SEGMENT
$T1 = -236						; size = 4
_nodePtr$ = -32						; size = 4
_newFront$ = -20					; size = 4
_this$ = -8						; size = 4
??1DynQueue@@QAE@XZ PROC				; DynQueue::~DynQueue, COMDAT
; _this$ = ecx
...
; 14   : 	QueueNode* newFront = nullptr;

	mov	DWORD PTR _newFront$[ebp], 0

; 15   : 	QueueNode* nodePtr = front;
...
; 17   : 	while (nodePtr->next)
	...
	mov	eax, DWORD PTR _nodePtr$[ebp]
	cmp	DWORD PTR [eax+4], 0
	je	SHORT $LN4@DynQueue

; 18   : 	{
; 19   : 		newFront = front->next;
...
; 28   : }
	...
	pop	ebp
	ret	0
??1DynQueue@@QAE@XZ ENDP				; DynQueue::~DynQueue
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\DynQueue.cpp
;	COMDAT ??0DynQueue@@QAE@XZ
_TEXT	SEGMENT
_this$ = -8						; size = 4
??0DynQueue@@QAE@XZ PROC				; DynQueue::DynQueue, COMDAT
; _this$ = ecx
...
; 10   : }
	...
	pop	ebp
	ret	0
??0DynQueue@@QAE@XZ ENDP				; DynQueue::DynQueue
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\DynQueueDriver.cpp
