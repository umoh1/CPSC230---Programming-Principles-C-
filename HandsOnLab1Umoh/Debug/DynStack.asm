...
; 41   : 	StackNode* nodePtr = top;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR _nodePtr$[ebp], ecx

; 42   : 	StackNode* nextPtr = nullptr;
...
; 47   : 	else
; 48   : 	{
; 49   : 		cout << "Popping " << nodePtr->value << endl;
...
; 50   : 		//set top next to the second node
...
; 52   : 
; 53   : 		//now pointing to second node;
; 54   : 		nextPtr = nodePtr;

	mov	eax, DWORD PTR _nodePtr$[ebp]
	mov	DWORD PTR _nextPtr$[ebp], eax

; 55   : 
; 56   : 		//set top = to the second node
; 57   : 		top->next = nextPtr;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax]
	mov	edx, DWORD PTR _nextPtr$[ebp]
...
; 13   : 
; 14   : 
; 15   : 	StackNode* newNode = nullptr;

	mov	DWORD PTR _newNode$[ebp], 0

; 16   : 	StackNode* nodePtr = top;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR _nodePtr$[ebp], ecx

; 17   : 	StackNode* previous = top;
...
; 21   : 
; 22   : 	//if there is no top, set top = to the first node
; 23   : 	if (!top)
...
; 27   : 	else
; 28   : 	{
; 29   : 		cout << "Pushing " << newNode->value << endl;
...
; 30   : 		nodePtr = top->next;		//set nodePtr to second node
...
; 31   : 
; 32   : 		top->next = newNode;		//set top = to the new node
...
; 33   : 
; 34   : 		newNode->next = nodePtr;	//set the newNode = to the second node
