; Listing generated by Microsoft (R) Optimizing Compiler Version 19.28.29336.0 
	...
	TITLE	C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch12lab1.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__35A99960_Ch12lab1@cpp DB 01H
...
PUBLIC	??_C@_0FE@FGOHOBFF@C?3?2Users?2nsika?2OneDrive?2Attachm@ ; `string'
...
PUBLIC	??_C@_0CO@NLBBKJH@Payrate?5?5?5?5?5?5Hours?5?5?5?5Gross?5Pay@ ; `string'
...
CONST	ENDS
;	COMDAT ??_C@_0CO@NLBBKJH@Payrate?5?5?5?5?5?5Hours?5?5?5?5Gross?5Pay@
CONST	SEGMENT
??_C@_0CO@NLBBKJH@Payrate?5?5?5?5?5?5Hours?5?5?5?5Gross?5Pay@ DB 'Payrate'
	DB	'      Hours    Gross Pay       Net Pay', 00H ; `string'
CONST	ENDS
...
??_C@_0BG@DKBGJNBA@Error?5opening?5file?4?5?6@ DB 'Error opening file. ', 0aH
	DB	00H						; `string'
CONST	ENDS
;	COMDAT ??_C@_0FE@FGOHOBFF@C?3?2Users?2nsika?2OneDrive?2Attachm@
CONST	SEGMENT
??_C@_0FE@FGOHOBFF@C?3?2Users?2nsika?2OneDrive?2Attachm@ DB 'C:\Users\nsi'
	DB	'ka\OneDrive\Attachments\Desktop\AccessFormTemplates\General\p'
	DB	'ayroll.dat', 00H				; `string'
CONST	ENDS
...
; 1347 :         int _Prot = ios_base::_Default_open_prot) {
...
; 1348 :         // _Prot is an extension
; 1349 :         if (_Filebuffer.open(_Filename, _Mode, _Prot)) {
...
; 1352 :             _Myios::setstate(ios_base::failbit);
...
; 1196 :     basic_fstream() : _Mybase(_STD addressof(_Filebuffer)) {}
...
; 7    : {
	...
	lea	eax, DWORD PTR __$EHRec$[ebp]
	mov	DWORD PTR fs:0, eax
	mov	ecx, OFFSET __35A99960_Ch12lab1@cpp
	call	@__CheckForDebuggerJustMyCode@4

; 8    : 	// Fill in the code to define payFile as an input file 
; 9    : 	float gross = 0;

	xorps	xmm0, xmm0
	movss	DWORD PTR _gross$[ebp], xmm0

; 10   : 	float net = 0;

	xorps	xmm0, xmm0
	movss	DWORD PTR _net$[ebp], xmm0

; 11   : 	float hours = 0;

	xorps	xmm0, xmm0
	movss	DWORD PTR _hours$[ebp], xmm0

; 12   : 	float payRate = 0;

	xorps	xmm0, xmm0
	movss	DWORD PTR _payRate$[ebp], xmm0

; 13   : 	float stateTax = 0;

	xorps	xmm0, xmm0
	movss	DWORD PTR _stateTax$[ebp], xmm0

; 14   : 	float fedTax = 0;

	xorps	xmm0, xmm0
	movss	DWORD PTR _fedTax$[ebp], xmm0

; 15   : 
; 16   : 	fstream payFile;

	push	192					; 000000c0H
	lea	ecx, DWORD PTR _payFile$[ebp]
...
; 17   : 
; 18   : 	cout << fixed << setprecision(2) << showpoint;
...
; 19   : 	payFile.open("C:\\Users\\nsika\\OneDrive\\Attachments\\Desktop\\AccessFormTemplates\\General\\payroll.dat", ios::in);

	push	64					; 00000040H
	push	1
	push	OFFSET ??_C@_0FE@FGOHOBFF@C?3?2Users?2nsika?2OneDrive?2Attachm@
	lea	ecx, DWORD PTR _payFile$[ebp]
...
; 21   : 	if (!payFile)
	...
	mov	eax, DWORD PTR _payFile$[ebp]
	mov	ecx, DWORD PTR [eax+4]
	lea	ecx, DWORD PTR _payFile$[ebp+ecx]
	mov	esi, esp
...
; 24   : 		cout << "It may not exist where indicated" << endl;
...
; 26   : 	}
; 27   : 
; 28   : 	cout << "Payrate      Hours    Gross Pay       Net Pay"

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	mov	edi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0CO@NLBBKJH@Payrate?5?5?5?5?5?5Hours?5?5?5?5Gross?5Pay@
	mov	eax, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	eax
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
...
; 32   : 	{
; 33   : 		payFile >> hours >> payRate >> stateTax >> fedTax;

	mov	esi, esp
	lea	eax, DWORD PTR _fedTax$[ebp]
	push	eax
	mov	edi, esp
	lea	ecx, DWORD PTR _stateTax$[ebp]
	push	ecx
	mov	ebx, esp
	lea	edx, DWORD PTR _payRate$[ebp]
	push	edx
	mov	eax, esp
	lea	ecx, DWORD PTR _hours$[ebp]
	push	ecx
	lea	ecx, DWORD PTR _payFile$[ebp]
...
; 34   : 		gross = payRate * hours;

	movss	xmm0, DWORD PTR _payRate$[ebp]
	mulss	xmm0, DWORD PTR _hours$[ebp]
	movss	DWORD PTR _gross$[ebp], xmm0

; 35   : 		net = gross - (gross * stateTax) - (gross * fedTax);

	movss	xmm0, DWORD PTR _gross$[ebp]
	mulss	xmm0, DWORD PTR _stateTax$[ebp]
	movss	xmm1, DWORD PTR _gross$[ebp]
	subss	xmm1, xmm0
	movss	xmm0, DWORD PTR _gross$[ebp]
	mulss	xmm0, DWORD PTR _fedTax$[ebp]
	subss	xmm1, xmm0
	movss	DWORD PTR _net$[ebp], xmm1

; 36   : 		cout << payRate << setw(15) << hours << setw(12) << gross

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	mov	edi, esp
	push	ecx
	movss	xmm0, DWORD PTR _net$[ebp]
...
; 37   : 			<< setw(12) << net << endl;
; 38   : 		//payFile >> ;// FILL IN THE CODE TO FINISH THIS WITH THE APPROPRIATE  
; 39   : 				   // VARIABLE TO BE INPUT
; 40   : 	}
