; Listing generated by Microsoft (R) Optimizing Compiler Version 19.28.29336.0 
	...
	TITLE	C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch10Lab5Option2.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__8502CAF9_Ch10Lab5Option2@cpp DB 01H
...
PUBLIC	??_C@_0BN@NCICIJO@Please?5input?5the?5first?5name?5@ ; `string'
PUBLIC	??_C@_0BM@DLLJOBEB@Please?5input?5the?5last?5name?5@ ; `string'
PUBLIC	??_C@_0BL@MOHNFAEE@The?5names?5are?5as?5follows?3?5@ ; `string'
EXTRN	_strcmp:PROC
EXTRN	_strlen:PROC
...
rtc$IMZ	ENDS
;	COMDAT ??_C@_0BL@MOHNFAEE@The?5names?5are?5as?5follows?3?5@
CONST	SEGMENT
??_C@_0BL@MOHNFAEE@The?5names?5are?5as?5follows?3?5@ DB 'The names are as'
	DB	' follows: ', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0BM@DLLJOBEB@Please?5input?5the?5last?5name?5@
CONST	SEGMENT
??_C@_0BM@DLLJOBEB@Please?5input?5the?5last?5name?5@ DB 'Please input the'
	DB	' last name ', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0BN@NCICIJO@Please?5input?5the?5first?5name?5@
CONST	SEGMENT
??_C@_0BN@NCICIJO@Please?5input?5the?5first?5name?5@ DB 'Please input the'
	DB	' first name ', 00H				; `string'
CONST	ENDS
;	COMDAT xdata$x
xdata$x	SEGMENT
...
; 7    : {
	...
	xor	eax, ebp
	mov	DWORD PTR __$ArrayPad$[ebp], eax
	mov	ecx, OFFSET __8502CAF9_Ch10Lab5Option2@cpp
	call	@__CheckForDebuggerJustMyCode@4

; 8    : 	char string1[STRINGTEXT];
; 9    : 	char string2[STRINGTEXT];
; 10   : 
; 11   : 	cout << "Please input the first name " << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0BN@NCICIJO@Please?5input?5the?5first?5name?5@
...
; 12   : 	cin.getline(string1, STRINGTEXT);
...
; 13   : 
; 14   : 	cout << "Please input the last name " << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0BM@DLLJOBEB@Please?5input?5the?5last?5name?5@
	mov	eax, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	eax
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
...
; 15   : 	cin.getline(string2, STRINGTEXT);
...
; 18   : 	cout << endl<<"The names are as follows: " << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0BL@MOHNFAEE@The?5names?5are?5as?5follows?3?5@
	mov	edi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
...
; 19   : 
; 20   : 	//if string1 comes before string2 alphabetically, print string 1 then 2
; 21   : 	if (strcmp(string1, string2) > 0)
...
; 22   : 	{
; 23   : 		while (string2[count] != '\0')

	mov	eax, DWORD PTR _count$[ebp]
	movsx	ecx, BYTE PTR _string2$[ebp+eax]
	test	ecx, ecx
	je	SHORT $LN3@main

; 24   : 		{
; 25   : 			cout << string2[count];

	mov	eax, DWORD PTR _count$[ebp]
	movzx	ecx, BYTE PTR _string2$[ebp+eax]
	push	ecx
...
; 30   : 		while (string1[count] != '\0')

	mov	eax, DWORD PTR _count$[ebp]
	movsx	ecx, BYTE PTR _string1$[ebp+eax]
	test	ecx, ecx
	je	SHORT $LN5@main

; 31   : 		{
; 32   : 			cout << string1[count];

	mov	eax, DWORD PTR _count$[ebp]
	movzx	ecx, BYTE PTR _string1$[ebp+eax]
	push	ecx
	mov	edx, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	edx
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@D@Z ; std::operator<<<std::char_traits<char> >
...
; 36   : 
; 37   : 	//if string2 comes before string1 alphabetically, print string2 then 1
; 38   : 	else if(strcmp(string1, string2) < 0)
