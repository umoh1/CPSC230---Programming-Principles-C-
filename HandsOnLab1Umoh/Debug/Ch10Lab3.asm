; Listing generated by Microsoft (R) Optimizing Compiler Version 19.28.29336.0 
	...
	TITLE	C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch10Lab3.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__98E980D0_Ch10Lab3@cpp DB 01H
...
PUBLIC	??_C@_0DH@FAEGNJIF@Enter?5your?5last?5name?5using?5no?5m@ ; `string'
PUBLIC	??_C@_0BF@LCAHFMPB@The?5name?5entered?5is?5@	; `string'
...
CONST	ENDS
;	COMDAT ??_C@_0BF@LCAHFMPB@The?5name?5entered?5is?5@
CONST	SEGMENT
??_C@_0BF@LCAHFMPB@The?5name?5entered?5is?5@ DB 'The name entered is ', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0DH@FAEGNJIF@Enter?5your?5last?5name?5using?5no?5m@
CONST	SEGMENT
??_C@_0DH@FAEGNJIF@Enter?5your?5last?5name?5using?5no?5m@ DB 'Enter your '
	DB	'last name using no more than 9 characters: ', 00H ; `string'
CONST	ENDS
...
; 11   : {
	...
	xor	eax, ebp
	mov	DWORD PTR __$ArrayPad$[ebp], eax
	mov	ecx, OFFSET __98E980D0_Ch10Lab3@cpp
	call	@__CheckForDebuggerJustMyCode@4

; 12   : 
; 13   : 	char name1[MAXNAME];  // holds student name
; 14   : 
; 15   : 	int count = 0;
...
; 16   : 
; 17   : 	cout << "Enter your last name using no more than 9 characters: " << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0DH@FAEGNJIF@Enter?5your?5last?5name?5using?5no?5m@
...
; 21   : 		cin >> name1[count];
	...
	lea	ecx, DWORD PTR _name1$[ebp+eax]
	push	ecx
...
$LN8@main:
	...
	mov	BYTE PTR _name1$[ebp+edx], 0

; 25   : 
; 26   : 	cout << "The name entered is ";

	push	OFFSET ??_C@_0BF@LCAHFMPB@The?5name?5entered?5is?5@
	mov	eax, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	eax
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
...
; 28   : 	while (name1[count]!='\0')

	mov	eax, DWORD PTR _count$[ebp]
	movsx	ecx, BYTE PTR _name1$[ebp+eax]
	test	ecx, ecx
	je	SHORT $LN5@main
...
; 30   : 		cout << name1[count];
	...
	mov	eax, DWORD PTR _count$[ebp]
	movzx	ecx, BYTE PTR _name1$[ebp+eax]
	push	ecx
