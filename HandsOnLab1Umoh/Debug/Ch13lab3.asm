; Listing generated by Microsoft (R) Optimizing Compiler Version 19.28.29336.0 
	...
	TITLE	C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch13lab3.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__5812DE43_Ch13lab3@cpp DB 01H
...
PUBLIC	?getList@FloatList@@QAEXAAV?$basic_ifstream@DU?$char_traits@D@std@@@std@@@Z ; FloatList::getList
PUBLIC	?printList@FloatList@@QBEXXZ			; FloatList::printList
PUBLIC	??0FloatList@@QAE@XZ				; FloatList::FloatList
PUBLIC	??1FloatList@@QAE@XZ				; FloatList::~FloatList
PUBLIC	?average@FloatList@@QAENXZ			; FloatList::average
PUBLIC	_main
...
PUBLIC	??_C@_0CK@OHMMCEHK@C?3?2Users?2nsika?2Downloads?2temper@ ; `string'
PUBLIC	??_C@_0BM@CJPILLCP@The?5average?5temperature?5is?5@ ; `string'
PUBLIC	??_C@_0BF@FMCIEAKD@Unable?5to?5open?5file?4@	; `string'
...
CONST	ENDS
;	COMDAT ??_C@_0BF@FMCIEAKD@Unable?5to?5open?5file?4@
CONST	SEGMENT
??_C@_0BF@FMCIEAKD@Unable?5to?5open?5file?4@ DB 'Unable to open file.', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BM@CJPILLCP@The?5average?5temperature?5is?5@
CONST	SEGMENT
??_C@_0BM@CJPILLCP@The?5average?5temperature?5is?5@ DB 'The average tempe'
	DB	'rature is ', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0CK@OHMMCEHK@C?3?2Users?2nsika?2Downloads?2temper@
CONST	SEGMENT
??_C@_0CK@OHMMCEHK@C?3?2Users?2nsika?2Downloads?2temper@ DB 'C:\Users\nsi'
	DB	'ka\Downloads\temperatures.txt', 00H		; `string'
CONST	ENDS
...
; 955  :         const char* _Filename, ios_base::openmode _Mode = ios_base::in, int _Prot = ios_base::_Default_open_prot) {
...
; 956  :         // _Prot is an extension
; 957  :         if (_Filebuffer.open(_Filename, _Mode | ios_base::in, _Prot)) {
...
; 960  :             _Myios::setstate(ios_base::failbit);
...
; 804  :     basic_ifstream() : _Mybase(_STD addressof(_Filebuffer)) {}
...
$T2 = -644						; size = 4
$T3 = -632						; size = 16
_floater$ = -416					; size = 204
_tempData$ = -204					; size = 184
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
_main	PROC						; COMDAT
...
; 25   : {
	...
	lea	eax, DWORD PTR __$EHRec$[ebp]
	mov	DWORD PTR fs:0, eax
	mov	ecx, OFFSET __5812DE43_Ch13lab3@cpp
	call	@__CheckForDebuggerJustMyCode@4

; 26   : 	ifstream tempData;   // Defines a data file
...
; 27   : 	FloatList floater;

	lea	ecx, DWORD PTR _floater$[ebp]
	call	??0FloatList@@QAE@XZ			; FloatList::FloatList
	mov	BYTE PTR __$EHRec$[ebp+8], 1

; 28   : 
; 29   : 	// Fill in the code to define an object called list of the class FloatList
; 30   : 
; 31   : 	cout << fixed << showpoint;
...
; 33   : 
; 34   : 	tempData.open("C:\\Users\\nsika\\Downloads\\temperatures.txt");

	push	64					; 00000040H
	push	1
	push	OFFSET ??_C@_0CK@OHMMCEHK@C?3?2Users?2nsika?2Downloads?2temper@
	lea	ecx, DWORD PTR _tempData$[ebp]
...
; 36   : 	if (tempData)
	...
	mov	eax, DWORD PTR _tempData$[ebp]
	mov	ecx, DWORD PTR [eax+4]
	lea	ecx, DWORD PTR _tempData$[ebp+ecx]
	mov	esi, esp
...
; 37   : 	{
; 38   : 		
; 39   : 		floater.getList(tempData);

	lea	eax, DWORD PTR _tempData$[ebp]
	push	eax
	lea	ecx, DWORD PTR _floater$[ebp]
	call	?getList@FloatList@@QAEXAAV?$basic_ifstream@DU?$char_traits@D@std@@@std@@@Z ; FloatList::getList

; 40   : 		
; 41   : 		floater.printList();

	lea	ecx, DWORD PTR _floater$[ebp]
	call	?printList@FloatList@@QBEXXZ		; FloatList::printList

; 42   : 		cout<<"The average temperature is " << floater.average();

	lea	ecx, DWORD PTR _floater$[ebp]
	call	?average@FloatList@@QAENXZ		; FloatList::average
	mov	esi, esp
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET ??_C@_0BM@CJPILLCP@The?5average?5temperature?5is?5@
...
; 46   : 		cout << "Unable to open file." << endl;
	...
	push	OFFSET ??_C@_0BF@FMCIEAKD@Unable?5to?5open?5file?4@
	mov	eax, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	eax
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
...
; 47   : 	}
; 48   : 	
; 49   : 	// Fill in the code that calls the getList function.
; 50   : 	// Fill in the code that calls the printList function.
; 51   : 	
; 52   : 	tempData.close();
...
; 53   : 	return 0;
	...
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR _floater$[ebp]
	call	??1FloatList@@QAE@XZ			; FloatList::~FloatList
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _tempData$[ebp]
	call	??_D?$basic_ifstream@DU?$char_traits@D@std@@@std@@QAEXXZ
	mov	eax, DWORD PTR $T2[ebp]
...
__unwindfunclet$_main$1:
	lea	ecx, DWORD PTR _floater$[ebp]
	jmp	??1FloatList@@QAE@XZ			; FloatList::~FloatList
	int	3
	int	3
	int	3
	int	3
...
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch13lab3.cpp
;	COMDAT ?average@FloatList@@QAENXZ
_TEXT	SEGMENT
tv90 = -252						; size = 8
$T1 = -240						; size = 4
_i$2 = -36						; size = 4
_sum$ = -24						; size = 8
_this$ = -8						; size = 4
?average@FloatList@@QAENXZ PROC				; FloatList::average, COMDAT
; _this$ = ecx
...
; 105  : 		sum += values[i];
	...
	mov	eax, DWORD PTR _i$2[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	cvtss2sd xmm0, DWORD PTR [ecx+eax*4+4]
	addsd	xmm0, QWORD PTR _sum$[ebp]
	movsd	QWORD PTR _sum$[ebp], xmm0

; 106  : 	}

	jmp	SHORT $LN2@average
$LN3@average:
...
; 112  : }
	...
	pop	ebp
	ret	0
?average@FloatList@@QAENXZ ENDP				; FloatList::average
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch13lab3.cpp
;	COMDAT ??1FloatList@@QAE@XZ
_TEXT	SEGMENT
$T1 = -212						; size = 4
_this$ = -8						; size = 4
??1FloatList@@QAE@XZ PROC				; FloatList::~FloatList, COMDAT
; _this$ = ecx
...
; 98   : }
	...
	pop	ebp
	ret	0
??1FloatList@@QAE@XZ ENDP				; FloatList::~FloatList
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch13lab3.cpp
;	COMDAT ??0FloatList@@QAE@XZ
_TEXT	SEGMENT
_i$1 = -20						; size = 4
_this$ = -8						; size = 4
??0FloatList@@QAE@XZ PROC				; FloatList::FloatList, COMDAT
; _this$ = ecx
...
; 60   : 	// Fill in the code to complete this constructor that
; 61   : 	// sets the private data member length to 0
; 62   : 	length = 0;
...
; 65   : }
	...
	pop	ebp
	ret	0
??0FloatList@@QAE@XZ ENDP				; FloatList::FloatList
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch13lab3.cpp
;	COMDAT ?printList@FloatList@@QBEXXZ
_TEXT	SEGMENT
_i$1 = -20						; size = 4
_this$ = -8						; size = 4
?printList@FloatList@@QBEXXZ PROC			; FloatList::printList, COMDAT
; _this$ = ecx
...
; 92   : }
	...
	pop	ebp
	ret	0
?printList@FloatList@@QBEXXZ ENDP			; FloatList::printList
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch13lab3.cpp
;	COMDAT ?getList@FloatList@@QAEXAAV?$basic_ifstream@DU?$char_traits@D@std@@@std@@@Z
_TEXT	SEGMENT
$T1 = -240						; size = 4
_i$ = -36						; size = 4
_number$ = -24						; size = 4
...
__$ArrayPad$ = -4					; size = 4
_hey$ = 8						; size = 4
?getList@FloatList@@QAEXAAV?$basic_ifstream@DU?$char_traits@D@std@@@std@@@Z PROC ; FloatList::getList, COMDAT
; _this$ = ecx
...
$LN5@getList:
	...
	DB	114					; 00000072H
	DB	0
?getList@FloatList@@QAEXAAV?$basic_ifstream@DU?$char_traits@D@std@@@std@@@Z ENDP ; FloatList::getList
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
