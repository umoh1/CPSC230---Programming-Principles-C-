; Listing generated by Microsoft (R) Optimizing Compiler Version 19.28.29336.0 
	...
	TITLE	C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch10Lab5Option1.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__C2A2B029_Ch10Lab5Option1@cpp DB 01H
...
PUBLIC	??_C@_0CP@FNOILPBM@Enter?5a?5string?5of?5no?5more?5than?5@ ; `string'
PUBLIC	??_C@_0BL@HDMLBNNK@You?5entered?5a?5palindrome?4?5@ ; `string'
PUBLIC	??_C@_0BP@OPPKFLFM@You?5didn?8t?5enter?5a?5palindrome?4@ ; `string'
EXTRN	_strlen:PROC
...
rtc$IMZ	ENDS
;	COMDAT ??_C@_0BP@OPPKFLFM@You?5didn?8t?5enter?5a?5palindrome?4@
CONST	SEGMENT
??_C@_0BP@OPPKFLFM@You?5didn?8t?5enter?5a?5palindrome?4@ DB 'You didn''t '
	DB	'enter a palindrome.', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0BL@HDMLBNNK@You?5entered?5a?5palindrome?4?5@
CONST	SEGMENT
??_C@_0BL@HDMLBNNK@You?5entered?5a?5palindrome?4?5@ DB 'You entered a pal'
	DB	'indrome. ', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0CP@FNOILPBM@Enter?5a?5string?5of?5no?5more?5than?5@
CONST	SEGMENT
??_C@_0CP@FNOILPBM@Enter?5a?5string?5of?5no?5more?5than?5@ DB 'Enter a st'
	DB	'ring of no more than 50 characters: ', 00H	; `string'
CONST	ENDS
;	COMDAT xdata$x
xdata$x	SEGMENT
...
; 6    : {
	...
	xor	eax, ebp
	mov	DWORD PTR __$ArrayPad$[ebp], eax
	mov	ecx, OFFSET __C2A2B029_Ch10Lab5Option1@cpp
	call	@__CheckForDebuggerJustMyCode@4

; 7    : 	char string1[INPUTSIZE] = { '0' };

	mov	BYTE PTR _string1$[ebp], 48		; 00000030H
	push	49					; 00000031H
	push	0
	lea	eax, DWORD PTR _string1$[ebp+1]
	push	eax
	call	_memset
	add	esp, 12					; 0000000cH

; 8    : 
; 9    : 	cout << "Enter a string of no more than 50 characters: " << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0CP@FNOILPBM@Enter?5a?5string?5of?5no?5more?5than?5@
...
; 11   : 	
; 12   : 	//set the pointer to the end of the string
; 13   : 	int count = 0;
...
; 14   : 	int rev = 1;
	...
	mov	DWORD PTR _rev$[ebp], 1

; 15   : 	int length1 = strlen(string1);
...
; 16   : 	int flagger = 0;
	...
	mov	DWORD PTR _flagger$[ebp], 0
$LN2@main:

; 17   : 
; 18   : 	while (string1[count]!='\0')
...
; 19   : 	{
; 20   : 		if (string1[count] != string1[length1 - rev])

	mov	eax, DWORD PTR _count$[ebp]
	movsx	ecx, BYTE PTR _string1$[ebp+eax]
	mov	edx, DWORD PTR _length1$[ebp]
	sub	edx, DWORD PTR _rev$[ebp]
	movsx	eax, BYTE PTR _string1$[ebp+edx]
	cmp	ecx, eax
	je	SHORT $LN4@main
...
; 27   : //strcmp(string1, string2) == 0
; 28   : 	if (flagger==0)

	cmp	DWORD PTR _flagger$[ebp], 0
	jne	SHORT $LN5@main

; 29   : 	{
; 30   : 		cout << endl<<"You entered a palindrome. " << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0BL@HDMLBNNK@You?5entered?5a?5palindrome?4?5@
	mov	edi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
...
; 32   : 	else
; 33   : 	{
; 34   : 		cout << "You didn't enter a palindrome." << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0BP@OPPKFLFM@You?5didn?8t?5enter?5a?5palindrome?4@
	mov	eax, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	eax
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
