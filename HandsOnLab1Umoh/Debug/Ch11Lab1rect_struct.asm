; Listing generated by Microsoft (R) Optimizing Compiler Version 19.28.29336.0 
	...
	TITLE	C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch11Lab1rect_struct.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__A42EE2E4_Ch11Lab1rect_struct@cpp DB 01H
...
PUBLIC	??_C@_0CC@BPAKOAMH@Enter?5the?5length?5of?5a?5rectangle@ ; `string'
PUBLIC	??_C@_0CB@BBOHMLPH@Enter?5the?5width?5of?5a?5rectangle?3@ ; `string'
PUBLIC	??_C@_0BO@NENNOFIF@The?5area?5of?5the?5rectangle?5is?5@ ; `string'
PUBLIC	??_C@_0BE@LKDEIACB@The?5perimeter?5is?5a?5@	; `string'
PUBLIC	??_C@_0BK@LGDGCOIP@The?5rectangle?5is?5a?5square@ ; `string'
PUBLIC	??_C@_0BO@OBOBAJDI@The?5rectangle?5is?5not?5a?5square@ ; `string'
...
CONST	ENDS
;	COMDAT ??_C@_0BO@OBOBAJDI@The?5rectangle?5is?5not?5a?5square@
CONST	SEGMENT
??_C@_0BO@OBOBAJDI@The?5rectangle?5is?5not?5a?5square@ DB 'The rectangle '
	DB	'is not a square', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0BK@LGDGCOIP@The?5rectangle?5is?5a?5square@
CONST	SEGMENT
??_C@_0BK@LGDGCOIP@The?5rectangle?5is?5a?5square@ DB 'The rectangle is a '
	DB	'square', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0BE@LKDEIACB@The?5perimeter?5is?5a?5@
CONST	SEGMENT
??_C@_0BE@LKDEIACB@The?5perimeter?5is?5a?5@ DB 'The perimeter is a ', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BO@NENNOFIF@The?5area?5of?5the?5rectangle?5is?5@
CONST	SEGMENT
??_C@_0BO@NENNOFIF@The?5area?5of?5the?5rectangle?5is?5@ DB 'The area of t'
	DB	'he rectangle is ', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0CB@BBOHMLPH@Enter?5the?5width?5of?5a?5rectangle?3@
CONST	SEGMENT
??_C@_0CB@BBOHMLPH@Enter?5the?5width?5of?5a?5rectangle?3@ DB 'Enter the w'
	DB	'idth of a rectangle: ', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0CC@BPAKOAMH@Enter?5the?5length?5of?5a?5rectangle@
CONST	SEGMENT
??_C@_0CC@BPAKOAMH@Enter?5the?5length?5of?5a?5rectangle@ DB 'Enter the le'
	DB	'ngth of a rectangle: ', 00H			; `string'
CONST	ENDS
...
; 17   : {
	...
	xor	eax, ebp
	mov	DWORD PTR __$ArrayPad$[ebp], eax
	mov	ecx, OFFSET __A42EE2E4_Ch11Lab1rect_struct@cpp
	call	@__CheckForDebuggerJustMyCode@4

; 18   :     // Fill IN CODE to declare a rectangle variable named box
; 19   :     rectangle box;
; 20   : 
; 21   :     cout << "Enter the length of a rectangle: ";

	push	OFFSET ??_C@_0CC@BPAKOAMH@Enter?5the?5length?5of?5a?5rectangle@
...
; 23   :     // FILL IN CODE to read in the length member of box
; 24   : 
; 25   :     cout << "Enter the width of a rectangle: ";

	push	OFFSET ??_C@_0CB@BBOHMLPH@Enter?5the?5width?5of?5a?5rectangle?3@
	mov	eax, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	eax
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
...
; 27   :     // FILL IN CODE to read in the width member of box
; 28   : 
; 29   :     cout << endl << endl;
...
; 30   : 
; 31   :     // FILL IN CODE to compute the area member of box
; 32   :     // FILL IN CODE to compute the perimeter member of box
; 33   :     box.area = box.length * box.width;

	movsd	xmm0, QWORD PTR _box$[ebp]
	mulsd	xmm0, QWORD PTR _box$[ebp+8]
	movsd	QWORD PTR _box$[ebp+16], xmm0

; 34   :     box.perimeter = (2 * box.length) + (2 * box.width);

	movsd	xmm0, QWORD PTR __real@4000000000000000
	mulsd	xmm0, QWORD PTR _box$[ebp]
	movsd	xmm1, QWORD PTR __real@4000000000000000
	mulsd	xmm1, QWORD PTR _box$[ebp+8]
	addsd	xmm0, xmm1
	movsd	QWORD PTR _box$[ebp+24], xmm0
...
; 36   :     cout << "The area of the rectangle is " << box.area;

	mov	esi, esp
	sub	esp, 8
	movsd	xmm0, QWORD PTR _box$[ebp+16]
	movsd	QWORD PTR [esp], xmm0
	push	OFFSET ??_C@_0BO@NENNOFIF@The?5area?5of?5the?5rectangle?5is?5@
	mov	eax, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	eax
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
...
; 37   :     cout << endl<<"The perimeter is a " << box.perimeter;

	mov	esi, esp
	sub	esp, 8
	movsd	xmm0, QWORD PTR _box$[ebp+24]
	movsd	QWORD PTR [esp], xmm0
	push	OFFSET ??_C@_0BE@LKDEIACB@The?5perimeter?5is?5a?5@
	mov	edi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	mov	ecx, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	call	DWORD PTR __imp_??6?$basic_ostream@DU?$char_traits@D@std@@@std@@QAEAAV01@P6AAAV01@AAV01@@Z@Z
...
; 39   :     
; 40   : 
; 41   :     // FILL IN CODE to output the area with an appropriate message
; 42   :     // FILL IN CODE to output the perimeter with an appropriate message
; 43   :     if (box.length==box.width)

	movsd	xmm0, QWORD PTR _box$[ebp]
	ucomisd	xmm0, QWORD PTR _box$[ebp+8]
	lahf
	test	ah, 68					; 00000044H
	jp	SHORT $LN2@main

; 44   :     {
; 45   :         cout << endl<<"The rectangle is a square"<<endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0BK@LGDGCOIP@The?5rectangle?5is?5a?5square@
	mov	edi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	mov	ecx, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	call	DWORD PTR __imp_??6?$basic_ostream@DU?$char_traits@D@std@@@std@@QAEAAV01@P6AAAV01@AAV01@@Z@Z
...
; 47   :     else
; 48   :     {
; 49   :         cout << endl<< "The rectangle is not a square" << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0BO@OBOBAJDI@The?5rectangle?5is?5not?5a?5square@
	mov	edi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	mov	ecx, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	call	DWORD PTR __imp_??6?$basic_ostream@DU?$char_traits@D@std@@@std@@QAEAAV01@P6AAAV01@AAV01@@Z@Z
