...
PUBLIC	?enqueue@QueueArray@@QAEXH@Z			; QueueArray::enqueue
...
$LN4@display:
	...
	jg	SHORT $LN1@display

; 88   : 	{
; 89   : 		cout << queueArray[i] << "\t";
...
; 46   : 		}
	...
	jmp	SHORT $LN8@dequeue
$LN7@dequeue:

; 47   : 		else
; 48   : 		{
; 49   : 			for (int i = 0; i < numItems-1; i++)
...
$LN4@dequeue:
	...
	jge	SHORT $LN8@dequeue

; 50   : 			{
; 51   : 				queueArray[i] = queueArray[i + 1];
...
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\QueueArray.cpp
;	COMDAT ?enqueue@QueueArray@@QAEXH@Z
_TEXT	SEGMENT
_this$ = -8						; size = 4
_n$ = 8							; size = 4
?enqueue@QueueArray@@QAEXH@Z PROC			; QueueArray::enqueue, COMDAT
; _this$ = ecx
...
; 28   : 	}
; 29   : 
; 30   : 	queueArray[numItems] = n;		//store n
...
; 31   : 	numItems++;		//increase number of items
...
; 32   : }
	...
	pop	ebp
	ret	4
?enqueue@QueueArray@@QAEXH@Z ENDP			; QueueArray::enqueue
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\QueueArray.cpp
...
; 7    : 	queueArray = new int[n];		//allocate static memory for array
...
; 8    : 	queueSize = 0;					//set size of queue to 0
