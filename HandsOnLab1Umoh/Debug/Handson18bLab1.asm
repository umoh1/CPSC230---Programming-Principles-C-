; Listing generated by Microsoft (R) Optimizing Compiler Version 19.28.29336.0 
	...
	TITLE	C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Handson18bLab1.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__FD613434_Handson18bLab1@cpp DB 01H
...
PUBLIC	?__autoclassinit2@ItemList@@QAEXI@Z		; ItemList::__autoclassinit2
...
PUBLIC	??_C@_0BF@PHCMHCHN@?5is?5not?5in?5the?5list?4@	; `string'
PUBLIC	??_C@_0BB@GNJLBKEJ@?5is?5in?5the?5list?4@	; `string'
...
PUBLIC	??_C@_0CB@KCLMPFCO@C?3?2Users?2nsika?2Downloads?2int?4tx@ ; `string'
PUBLIC	??_C@_0BE@LLILKBCC@?5items?5in?5the?5list?4@	; `string'
PUBLIC	??_C@_0L@GHAILMA@There?5are?5@			; `string'
PUBLIC	??_C@_0BE@ELLADFKA@Error?5opening?5file?4@	; `string'
PUBLIC	??_C@_0BP@PNOJICMP@After?5deletion?0?5there?5are?5now?5@ ; `string'
...
CONST	ENDS
;	COMDAT ??_C@_0BP@PNOJICMP@After?5deletion?0?5there?5are?5now?5@
CONST	SEGMENT
??_C@_0BP@PNOJICMP@After?5deletion?0?5there?5are?5now?5@ DB 'After deleti'
	DB	'on, there are now ', 00H			; `string'
CONST	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_0BE@LLILKBCC@?5items?5in?5the?5list?4@
CONST	SEGMENT
??_C@_0BE@LLILKBCC@?5items?5in?5the?5list?4@ DB ' items in the list.', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0CB@KCLMPFCO@C?3?2Users?2nsika?2Downloads?2int?4tx@
CONST	SEGMENT
??_C@_0CB@KCLMPFCO@C?3?2Users?2nsika?2Downloads?2int?4tx@ DB 'C:\Users\ns'
	DB	'ika\Downloads\int.txt', 00H			; `string'
CONST	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_0BB@GNJLBKEJ@?5is?5in?5the?5list?4@
CONST	SEGMENT
??_C@_0BB@GNJLBKEJ@?5is?5in?5the?5list?4@ DB ' is in the list.', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BF@PHCMHCHN@?5is?5not?5in?5the?5list?4@
CONST	SEGMENT
??_C@_0BF@PHCMHCHN@?5is?5not?5in?5the?5list?4@ DB ' is not in the list.', 00H ; `string'
CONST	ENDS
...
_TEXT	SEGMENT
$T2 = -432						; size = 4
_number$3 = -228					; size = 4
_inFile$ = -216						; size = 184
_items$ = -24						; size = 4
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
_main	PROC						; COMDAT
...
; 7    : {
	...
	lea	eax, DWORD PTR __$EHRec$[ebp]
	mov	DWORD PTR fs:0, eax
	mov	ecx, OFFSET __FD613434_Handson18bLab1@cpp
	call	@__CheckForDebuggerJustMyCode@4
...
; 8    : 	ItemList items;
	...
	call	?__autoclassinit2@ItemList@@QAEXI@Z
	lea	ecx, DWORD PTR _items$[ebp]
	call	??0ItemList@@QAE@XZ			; ItemList::ItemList
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 9    : 	ifstream inFile("C:\\Users\\nsika\\Downloads\\int.txt");
	...
	push	64					; 00000040H
	push	1
	push	OFFSET ??_C@_0CB@KCLMPFCO@C?3?2Users?2nsika?2Downloads?2int?4tx@
	lea	ecx, DWORD PTR _inFile$[ebp]
...
; 13   : 		int number = 0;
	...
	mov	DWORD PTR _number$3[ebp], 0
$LN2@main:

; 14   : 
; 15   : 		while (inFile >> number)
...
; 16   : 		{
; 17   : 			if (items.IsThere(number))

	mov	eax, DWORD PTR _number$3[ebp]
	push	eax
	lea	ecx, DWORD PTR _items$[ebp]
	call	?IsThere@ItemList@@QBE_NH@Z		; ItemList::IsThere
	movzx	ecx, al
	test	ecx, ecx
	je	SHORT $LN6@main
...
; 20   : 			}
; 21   : 			
; 22   : 			items.Insert(number); //insert numbers

	mov	eax, DWORD PTR _number$3[ebp]
	push	eax
	lea	ecx, DWORD PTR _items$[ebp]
	call	?Insert@ItemList@@QAEXH@Z		; ItemList::Insert
...
; 24   : 
; 25   : 		cout <<endl<< "There are " << items.GetLength() << " items in the list." << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0BE@LLILKBCC@?5items?5in?5the?5list?4@
	lea	ecx, DWORD PTR _items$[ebp]
	call	?GetLength@ItemList@@QBEHXZ		; ItemList::GetLength
	mov	edi, esp
	push	eax
...
; 26   : 		items.Print();
	...
	lea	ecx, DWORD PTR _items$[ebp]
	call	?Print@ItemList@@QBEXXZ			; ItemList::Print
...
; 34   : 		items.Delete(-47);
	...
	push	-47					; ffffffd1H
	lea	ecx, DWORD PTR _items$[ebp]
	call	?Delete@ItemList@@QAEXH@Z		; ItemList::Delete

; 35   : 		items.Delete(1926);

	push	1926					; 00000786H
	lea	ecx, DWORD PTR _items$[ebp]
	call	?Delete@ItemList@@QAEXH@Z		; ItemList::Delete

; 36   : 		items.Delete(2000);

	push	2000					; 000007d0H
	lea	ecx, DWORD PTR _items$[ebp]
	call	?Delete@ItemList@@QAEXH@Z		; ItemList::Delete

; 37   : 		cout <<endl<< "After deletion, there are now " << items.GetLength() << " items in the list." << endl;
	...
	mov	edi, esp
	push	eax
	push	OFFSET ??_C@_0BP@PNOJICMP@After?5deletion?0?5there?5are?5now?5@
	mov	ebx, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	mov	ecx, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	call	DWORD PTR __imp_??6?$basic_ostream@DU?$char_traits@D@std@@@std@@QAEAAV01@P6AAAV01@AAV01@@Z@Z
...
; 40   : }
	...
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _items$[ebp]
	call	??1ItemList@@QAE@XZ			; ItemList::~ItemList
	xor	eax, eax
	push	edx
	mov	ecx, ebp
	push	eax
...
__unwindfunclet$_main$0:
	lea	ecx, DWORD PTR _items$[ebp]
	jmp	??1ItemList@@QAE@XZ			; ItemList::~ItemList
...
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ?__autoclassinit2@ItemList@@QAEXI@Z
_TEXT	SEGMENT
_this$ = -8						; size = 4
_classSize$ = 8						; size = 4
?__autoclassinit2@ItemList@@QAEXI@Z PROC		; ItemList::__autoclassinit2, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
	...
	pop	ebp
	ret	4
?__autoclassinit2@ItemList@@QAEXI@Z ENDP		; ItemList::__autoclassinit2
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
...
; 179  : 	ListNode* nodePtr;	//current node
; 180  : 	ListNode* nextNode;	//next node
; 181  : 
; 182  : 	nodePtr = head;
...
; 183  : 
; 184  : 	//while theres more nodes
; 185  : 	while (nodePtr != NULL)
...
; 165  : 
; 166  : 	//run through list
; 167  : 	while (nodePtr ->next)
...
; 142  : 	ListNode* nodePtr;
; 143  : 
; 144  : 	//start at head of list
; 145  : 	nodePtr = head;
...
; 146  : 
; 147  : 	//run through list, print items
; 148  : 	while (nodePtr->next)
...
; 151  : 
; 152  : 		//set nodePtr to next, going to next node
; 153  : 		nodePtr = nodePtr->next;
...
; 98   : 	//run through list, find item
; 99   : 	ListNode* nodePtr;
; 100  : 	ListNode* previousNode = nullptr;
...
; 102  : 	
; 103  : 
; 104  : 	//if the node right after the head is the one to delete
; 105  : 	if (!head)
...
; 106  : 	{
; 107  : 		//goes from head to first node
; 108  : 		cout << "Nothing in list." << endl;
...
; 110  : 	}
; 111  : 
; 112  : 	//if the first node is the one to be deleted
; 113  : 	if (head->value == item)
...
; 122  : 
; 123  : 		while (nodePtr != NULL && nodePtr ->value !=item)
...
; 124  : 		{
; 125  : 			previousNode = nodePtr;

	mov	eax, DWORD PTR _nodePtr$[ebp]
	mov	DWORD PTR _previousNode$[ebp], eax

; 126  : 			nodePtr = nodePtr->next;			
...
; 130  : 		{
; 131  : 			previousNode->next = nodePtr->next;
...
; 41   : 	ListNode* newNode;//points to new node
; 42   : 	ListNode *nodePtr; //to move thru list
; 43   : 
; 44   : 	ListNode* previous;	//points to previous
; 45   : 
; 46   : 	//enter item in newNode value
; 47   : 	newNode = new ListNode;
...
; 54   : 
; 55   : 	//run through list, find last node
; 56   : 
; 57   : 	if (!head)	//if there is no head
...
; 63   : 	else
; 64   : 	{
; 65   : 		//set nodeptr & previous = to beginning of list
; 66   : 		nodePtr = head;
...
; 68   : 
; 69   : 		//traverse the list, while next is not a nullptr & nodePtr value is less than item
; 70   : 		while (nodePtr->next&&nodePtr->value<item)
...
; 71   : 		{
; 72   : 			//move the previous pointer up to trail
; 73   : 			previous = nodePtr;
...
; 74   : 
; 75   : 			//set nodePtr to next, going to next node
; 76   : 			nodePtr = nodePtr->next;
...
; 85   : 		else
; 86   : 		{
; 87   : 			previous->next = newNode;

	mov	eax, DWORD PTR _previous$[ebp]
	mov	ecx, DWORD PTR _newNode$[ebp]
	mov	DWORD PTR [eax+4], ecx

; 88   : 			newNode->next = nodePtr;
...
; 17   : 	if (!head)
	...
	mov	eax, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [eax], 0
	jne	SHORT $LN2@IsThere

; 18   : 	{
; 19   : 		// cout << "Hey. " << head->value << endl << endl;
; 20   : 		cout << item << " is not in the list." << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0BF@PHCMHCHN@?5is?5not?5in?5the?5list?4@
	mov	edi, esp
...
; 25   : 	{
; 26   : 		if (nodePtr->value == item)

	mov	eax, DWORD PTR _nodePtr$[ebp]
	mov	ecx, DWORD PTR [eax]
	cmp	ecx, DWORD PTR _item$[ebp]
	jne	SHORT $LN5@IsThere

; 27   : 		{
; 28   : 			cout << item << " is in the list." << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0BB@GNJLBKEJ@?5is?5in?5the?5list?4@
	mov	edi, esp
	mov	eax, DWORD PTR _item$[ebp]
	push	eax
	mov	ecx, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
...
; 35   : 	cout << item << " is not in the list." << endl;
