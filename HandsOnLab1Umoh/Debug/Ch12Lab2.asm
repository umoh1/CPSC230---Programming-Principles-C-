; Listing generated by Microsoft (R) Optimizing Compiler Version 19.28.29336.0 
	...
	TITLE	C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch12Lab2.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__8B7F81E6_Ch12Lab2@cpp DB 01H
...
PUBLIC	?readIt@@YAXAAV?$basic_ifstream@DU?$char_traits@D@std@@@std@@QAUGrades@@H@Z ; readIt
PUBLIC	_main
...
PUBLIC	??_C@_0CH@PCBABKDA@C?3?2Users?2nsika?2Downloads?2grader@ ; `string'
PUBLIC	??_C@_0BG@DKBGJNBA@Error?5opening?5file?4?5?6@	; `string'
PUBLIC	??_C@_0CB@MMMPLPEN@It?5may?5not?5exist?5where?5indicate@ ; `string'
...
CONST	ENDS
;	COMDAT ??_C@_0CB@MMMPLPEN@It?5may?5not?5exist?5where?5indicate@
CONST	SEGMENT
??_C@_0CB@MMMPLPEN@It?5may?5not?5exist?5where?5indicate@ DB 'It may not e'
	DB	'xist where indicated', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0BG@DKBGJNBA@Error?5opening?5file?4?5?6@
CONST	SEGMENT
??_C@_0BG@DKBGJNBA@Error?5opening?5file?4?5?6@ DB 'Error opening file. ', 0aH
	DB	00H						; `string'
CONST	ENDS
;	COMDAT ??_C@_0CH@PCBABKDA@C?3?2Users?2nsika?2Downloads?2grader@
CONST	SEGMENT
??_C@_0CH@PCBABKDA@C?3?2Users?2nsika?2Downloads?2grader@ DB 'C:\Users\nsi'
	DB	'ka\Downloads\graderoll.dat', 00H		; `string'
CONST	ENDS
...
$T5 = -2440						; size = 16
$T6 = -2416						; size = 4
_count$7 = -1636					; size = 4
_studentRecord$ = -1624					; size = 1400
_numRecord$ = -216					; size = 4
_indata$ = -204						; size = 184
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
_main	PROC						; COMDAT
...
; 23   : {
	...
	lea	eax, DWORD PTR __$EHRec$[ebp]
	mov	DWORD PTR fs:0, eax
	mov	ecx, OFFSET __8B7F81E6_Ch12Lab2@cpp
	call	@__CheckForDebuggerJustMyCode@4

; 24   : 	ifstream indata;

	push	184					; 000000b8H
	lea	ecx, DWORD PTR _indata$[ebp]
...
; 25   : 	indata.open("C:\\Users\\nsika\\Downloads\\graderoll.dat");

	push	64					; 00000040H
	push	1
	push	OFFSET ??_C@_0CH@PCBABKDA@C?3?2Users?2nsika?2Downloads?2grader@
	lea	ecx, DWORD PTR _indata$[ebp]
	call	?open@?$basic_ifstream@DU?$char_traits@D@std@@@std@@QAEXPBDHH@Z ; std::basic_ifstream<char,std::char_traits<char> >::open

; 26   : 	int numRecord = 4;                  // number of records read in

	mov	DWORD PTR _numRecord$[ebp], 4

; 27   : 	gradeType studentRecord;
; 28   : 
; 29   : 	if (!indata)

	mov	eax, DWORD PTR _indata$[ebp]
	mov	ecx, DWORD PTR [eax+4]
	lea	ecx, DWORD PTR _indata$[ebp+ecx]
	mov	esi, esp
...
; 31   : 		cout << "Error opening file. \n";
	...
	push	OFFSET ??_C@_0BG@DKBGJNBA@Error?5opening?5file?4?5?6@
	mov	eax, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	eax
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8

; 32   : 		cout << "It may not exist where indicated" << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0CB@MMMPLPEN@It?5may?5not?5exist?5where?5indicate@
	mov	eax, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	eax
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
...
; 34   : 	}
; 35   : 
; 36   : 	readIt(indata, studentRecord, numRecord);

	mov	eax, DWORD PTR _numRecord$[ebp]
	push	eax
	lea	ecx, DWORD PTR _studentRecord$[ebp]
	push	ecx
	lea	edx, DWORD PTR _indata$[ebp]
	push	edx
	call	?readIt@@YAXAAV?$basic_ifstream@DU?$char_traits@D@std@@@std@@QAUGrades@@H@Z ; readIt
	add	esp, 12					; 0000000cH

; 37   : 
; 38   : 	// output the information 
; 39   : 	for (int count = 0; count < numRecord; count++)
...
$LN4@main:
	mov	eax, DWORD PTR _count$7[ebp]
	cmp	eax, DWORD PTR _numRecord$[ebp]
	jge	$LN3@main

; 40   : 	{
; 41   : 		cout << studentRecord[count].name << setw(10)

	imul	eax, DWORD PTR _count$7[ebp], 28
	mov	esi, esp
	mov	ecx, DWORD PTR _studentRecord$[ebp+eax+20]
	push	ecx
	push	0
	push	10					; 0000000aH
	...
	imul	eax, DWORD PTR _count$7[ebp], 28
	mov	edi, esp
	mov	ecx, DWORD PTR _studentRecord$[ebp+eax+16]
	push	ecx
	push	0
	push	10					; 0000000aH
	lea	edx, DWORD PTR $T4[ebp]
	...
	push	eax
	imul	eax, DWORD PTR _count$7[ebp], 28
	lea	ecx, DWORD PTR _studentRecord$[ebp+eax]
	push	ecx
...
; 42   : 			<< studentRecord[count].test1
; 43   : 			<< setw(10) << studentRecord[count].test2;
; 44   : 		cout << setw(10) << studentRecord[count].final << endl;

	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	imul	eax, DWORD PTR _count$7[ebp], 28
	mov	edi, esp
	mov	ecx, DWORD PTR _studentRecord$[ebp+eax+24]
	push	ecx
	push	0
	push	10					; 0000000aH
...
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\nsika\source\repos\HandsOnLab1Umoh\HandsOnLab1Umoh\Ch12Lab2.cpp
;	COMDAT ?readIt@@YAXAAV?$basic_ifstream@DU?$char_traits@D@std@@@std@@QAUGrades@@H@Z
_TEXT	SEGMENT
_inData$ = 8						; size = 4
_gradeRec$ = 12						; size = 4
_total$ = 16						; size = 4
?readIt@@YAXAAV?$basic_ifstream@DU?$char_traits@D@std@@@std@@QAUGrades@@H@Z PROC ; readIt, COMDAT
...
; 53   : 
; 54   : 	inData.get(gradeRec[total].name, NAMESIZE);

	mov	esi, esp
	push	0
	push	15					; 0000000fH
	imul	eax, DWORD PTR _total$[ebp], 28
	add	eax, DWORD PTR _gradeRec$[ebp]
	push	eax
...
; 57   : 	{
; 58   : 		// FILL IN THE CODE TO READ test1
; 59   : 		inData >> gradeRec[total].test1;

	imul	eax, DWORD PTR _total$[ebp], 28
	mov	ecx, DWORD PTR _gradeRec$[ebp]
...
; 60   : 
; 61   : 		// FILL IN THE CODE TO READ test2
; 62   : 		inData >> gradeRec[total].test2;
...
; 63   : 
; 64   : 		// FILL IN THE CODE TO READ final
; 65   : 		inData >> gradeRec[total].final;
...
; 69   : 
; 70   : 		// FILL IN THE CODE TO CONSUME THE END OF LINE
; 71   : 		inData.ignore();
	...
	push	1
	mov	ecx, DWORD PTR _inData$[ebp]
	call	DWORD PTR __imp_?ignore@?$basic_istream@DU?$char_traits@D@std@@@std@@QAEAAV12@_JH@Z
	cmp	esi, esp
	call	__RTC_CheckEsp

; 72   : 
; 73   : 		// FILL IN THE CODE TO READ name
; 74   : 		inData.get(gradeRec[total].name, NAMESIZE);
...
; 77   : }
	...
	pop	ebp
	ret	0
?readIt@@YAXAAV?$basic_ifstream@DU?$char_traits@D@std@@@std@@QAUGrades@@H@Z ENDP ; readIt
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
